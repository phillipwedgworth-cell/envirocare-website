...
export function getOrganizationSchema() {
  return {
    ...
    description:
      'EnviroCare Pest & Termite Services is a third-generation, family-owned Alabama pest and termite control company founded in 1958. Sentricon-certified termite specialist serving the Birmingham metro, Huntsville/North Alabama, and the Lake Martin / Alexander City area from three Alabama offices.',
...
export function getBirminghamSchema() {
  return {
    ...
    image: LOGO_URL,
    logo: LOGO_URL,
    url: `${BRAND_URL}/service-areas/birmingham`,
    telephone: '+12059406360',
    email: EMAIL,
    foundingDate: FOUNDING,
...
export function getHuntsvilleSchema() {
  return {
    ...
    image: LOGO_URL,
    logo: LOGO_URL,
    url: `${BRAND_URL}/service-areas/huntsville`,
    telephone: '+12569377676',
    email: EMAIL,
    foundingDate: FOUNDING,
    priceRange: PRICE_RANGE,
