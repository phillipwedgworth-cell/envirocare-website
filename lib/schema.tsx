...
export const SERVICE_CATALOG = {
  ...
  itemListElement: [
    ...
    { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Mosquito Control',
      description: 'Seasonal yard barrier treatment March through October. Reduces mosquitoes at breeding sites and on contact. Starting at $45 per visit, billed per service.' } },
    { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Tick and Flea Control',
      description: 'Yard tick treatment with chigger coverage. Offered with mosquito as Mosquito + Tick at $65 per visit (March through October). Tick is not sold standalone.' } },
