...
/* ── BRAND COLORS (confirmed from logo)
   Green:  #1B7A3C  (forest green — primary)
...
export default function SentriconProtection() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* HERO */}
      <section className="relative overflow-hidden text-white py-20 md:py-28" style={{background:"linear-gradient(135deg, #1B7A3C 0%, #0f4d26 60%, #1a1a1a 100%)"}}>
      ...
      <section className="py-10 px-6 bg-amber-50 border-y border-amber-200">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-5">
            <div className="w-16 h-16 rounded-full flex items-center justify-center flex-shrink-0" style={{background:"#1B7A3C"}}>
          ...
          <div className="flex-shrink-0 text-center">
            ...
            <p className="text-4xl font-bold" style={{color:"#1B7A3C"}}>1958</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <p className="font-semibold text-sm uppercase tracking-wider mb-3" style={{color:"#1B7A3C"}}>How It Works</p>
            ...
            {[
              ...
              <div key={i} className="rounded-2xl overflow-hidden border border-slate-200 shadow-sm hover:shadow-lg transition">
                <div className="relative h-48 overflow-hidden bg-slate-100">
                  ...
                  <div className="absolute top-4 left-4 w-12 h-12 rounded-full flex items-center justify-center font-bold text-white text-lg" style={{background:"#1B7A3C"}}>
                    {item.step}
                  </div>
                </div>
                <div className="p-6">
                  ...
                  <div className="flex items-start gap-2 p-3 rounded-lg" style={{background:"#f0fdf4", border:"1px solid #bbf7d0"}}>
                    <span style={{color:"#1B7A3C"}} className="font-bold mt-0.5 flex-shrink-0">💡</span>
          ...
          <div className="rounded-2xl overflow-hidden shadow-lg border border-slate-200">
            <div className="p-6 text-white text-center" style={{background:"#1B7A3C"}}>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="bg-slate-50">
                    ...
                    <th className="p-4 text-center font-bold" style={{color:"#1B7A3C"}}>Sentricon® System</th>
                ...
                <tbody>
                  {[
                    ...
                    <tr key={i} className={i % 2 === 0 ? "bg-white" : "bg-slate-50"}>
                      ...
                      <td className="p-4 text-center font-semibold text-sm" style={{color:"#1B7A3C"}}>{row.sentricon}</td>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-3">
                {[
                  ...
                  <div key={i} className="flex items-start gap-3">
                    <Shield className="w-5 h-5 flex-shrink-0 mt-0.5" style={{color:"#1B7A3C"}} />
            ...
            <div className="space-y-4">
              ...
              <div className="p-5 rounded-xl border-2" style={{borderColor:"#F5A800", background:"#fffbeb"}}>
                <p className="font-bold text-slate-900 mb-2" style={{color:"#1B7A3C"}}>EnviroCare Sentricon Fact</p>
      ...
      <section className="py-16 px-6 text-white" style={{background:"#1B7A3C"}}>
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
      ...
      {/* CTA */}
      <section className="py-20 px-6 text-white text-center" style={{background:"linear-gradient(135deg, #1B7A3C, #0f4d26)"}}>
      ...
      {quoteOpen && (
        <div className="fixed inset-0 bg-black/60 z-50 flex items-end sm:items-center justify-center p-4" onClick={() => setQuoteOpen(false)}>
          <div className="bg-white rounded-2xl w-full sm:w-[440px] overflow-hidden shadow-2xl" onClick={(e: React.MouseEvent) => e.stopPropagation()}>
            <div className="text-white p-5 flex justify-between items-start" style={{background:"#1B7A3C"}}>
              ...
              {[
                ...
                <a key={i} href={`tel:${o.tel}`}
                  ...
                  <div>
                    ...
                    <div className="font-bold mt-0.5" style={{color:"#1B7A3C"}}>{o.phone}</div>
                  </div>
