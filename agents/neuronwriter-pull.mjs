...
const SCRUB = [
  ...
  [/priced after a free on-site inspection, because an accurate number depends on the size of the structure and what is actually happening on the property/g, "mosquito service is $45 a month for an average-size yard, with eight treatments March through October, a firm price after a free inspection, and equal monthly ACH payments across the year; the price is $34 a month only with a pest plan. Mosquito + Tick is $65 a month, standalone tick and flea work is quoted, fire ant treatment is $150 for most yards, and termite work is quoted only after a free on-site WDO inspection"],
  [/mosquito control pairs well with tick service during peak outdoor season, and both are priced after a free on-site inspection/gi, "mosquito control can pair with quoted tick coverage on wooded lots; mosquito service is $45 a month for an average-size yard, with a firm price after a free inspection"],
