module.exports=[48182,a=>{"use strict";var b=a.i(87924),c=a.i(80826);let d=`
...
.rev-section{padding:5rem clamp(1.5rem,5vw,4rem);background:var(--cream)}
.rev-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(300px,1fr));gap:1.5rem;max-width:1180px;margin:2.4rem auto 0}
.rev-card{background:#fff;border:1px solid var(--border);border-radius:18px;padding:1.8rem 1.6rem;transition:transform .25s,box-shadow .25s;display:flex;flex-direction:column}
.rev-card:hover{transform:translateY(-4px);box-shadow:var(--sh-md)}
.rev-stars{font-size:1.2rem;color:var(--gold);margin-bottom:.8rem;letter-spacing:2px}
.rev-quote{font-family:"Playfair Display",serif;font-size:1.08rem;font-style:italic;color:var(--ink);line-height:1.5;margin-bottom:1.2rem;flex:1}
.rev-byline{font-size:13.5px;color:var(--ink-soft);font-weight:600;display:flex;justify-content:space-between;align-items:center;border-top:1px solid var(--border-soft);padding-top:1rem}
.rev-author{color:var(--green-deep)}
.rev-meta{font-size:11.5px;color:var(--ink-soft);font-weight:500}

.google-cta{background:linear-gradient(135deg,#fff 0%,var(--green-xlt) 100%);border:2px solid var(--gold);border-radius:20px;padding:3rem 2rem;text-align:center;max-width:780px;margin:3rem auto 0}
.google-cta-stars{font-size:2.4rem;color:var(--gold);margin-bottom:.6rem;letter-spacing:5px}
.google-cta-num{font-family:"Playfair Display",serif;font-size:clamp(2rem,4vw,3rem);font-weight:900;color:var(--green-deep);line-height:1;margin-bottom:.4rem}
.google-cta-lbl{font-size:1rem;color:var(--ink-soft);margin-bottom:1.5rem}

.blog-section{padding:5rem clamp(1.5rem,5vw,4rem);background:var(--white)}
...
.blog-thumb-icon{font-family:"Playfair Display",serif;font-size:3rem;color:var(--gold);font-weight:900}
...
.blog-title{font-family:"Playfair Display",serif;font-size:1.25rem;font-weight:700;color:var(--ink);line-height:1.25;margin-bottom:.7rem;flex:1}
.blog-excerpt{font-size:14.5px;color:var(--ink-soft);line-height:1.6;margin-bottom:1rem}
.blog-meta{font-size:12.5px;color:var(--ink-soft);display:flex;justify-content:space-between;border-top:1px solid var(--border-soft);padding-top:.9rem}
.blog-empty{text-align:center;padding:3rem 2rem;background:var(--cream);border-radius:18px;max-width:680px;margin:2rem auto;border:1px dashed var(--border)}
.blog-empty-icon{font-size:3rem;color:var(--green-mid);margin-bottom:1rem}
...
.svc-card-tag{font-size:11px;font-weight:700;color:var(--gold-deep);letter-spacing:.08em;text-transform:uppercase;margin-bottom:.4rem}
.svc-card-name{font-family:"Playfair Display",serif;font-size:1.35rem;font-weight:800;color:var(--green-deep);margin-bottom:.4rem;line-height:1.15}
.svc-card-price{font-family:"Playfair Display",serif;font-size:1.15rem;color:var(--gold-deep);font-weight:700;margin-bottom:.7rem}
.svc-card-desc{font-size:14px;color:var(--ink-soft);line-height:1.6;flex:1;margin-bottom:1rem}
.svc-card-link{font-size:13.5px;font-weight:700;color:var(--green-dk);text-decoration:none;display:inline-flex;align-items:center;gap:.3rem;transition:color .2s}
.svc-card-link:hover{color:var(--gold-deep)}

/* 404 specific */
.not-found-hero{min-height:60vh;display:flex;align-items:center;justify-content:center;text-align:center;padding:5rem clamp(1.5rem,5vw,4rem);background:linear-gradient(135deg,var(--green-deep) 0%,var(--green-dk) 50%,var(--green) 100%);color:#fff}
.not-found-num{font-family:"Playfair Display",serif;font-size:clamp(7rem,18vw,12rem);font-weight:900;color:var(--gold);line-height:1;margin-bottom:.5rem;letter-spacing:-4px}
.not-found-h{font-family:"Playfair Display",serif;font-size:clamp(1.8rem,4vw,2.8rem);font-weight:900;color:#fff;margin-bottom:1.2rem;line-height:1.1}
.not-found-h em{color:var(--gold);font-style:italic;font-weight:700}
.not-found-p{font-size:1.1rem;color:rgba(255,255,255,.88);max-width:620px;margin:0 auto 2rem;line-height:1.6}
.not-found-links{display:grid;grid-template-columns:repeat(auto-fit,minmax(200px,1fr));gap:1rem;max-width:780px;margin:0 auto}
.nf-link{background:rgba(255,255,255,.08);border:1px solid rgba(255,255,255,.18);border-radius:14px;padding:1.2rem;text-decoration:none;color:#fff;transition:all .25s;text-align:left}
.nf-link:hover{background:rgba(245,168,0,.18);border-color:var(--gold);transform:translateY(-3px)}
...
`;a.s(["default",0,function(){return(0,c.useEffect)(()=>{if("u"<typeof document)return;let a=[];return[{rel:"preconnect",href:"https://fonts.googleapis.com"},{rel:"preconnect",href:"https://fonts.gstatic.com",crossOrigin:"anonymous"},{rel:"stylesheet",href:"https://fonts.googleapis.com/css2?family=Playfair+Display:ital,wght@0,700;0,900;1,700&family=DM+Sans:wght@300;400;500;600;700&display=swap"}].forEach(b=>{if(document.head.querySelector(`link[href="${b.href}"]`))return;let c=document.createElement("link");Object.entries(b).forEach(([a,b])=>{"crossOrigin"===a?c.crossOrigin=b:c.setAttribute(a,b)}),document.head.appendChild(c),a.push(c)}),()=>{a.forEach(a=>a.remove())}},[]),(0,b.jsxs)(b.Fragment,{children:[(0,b.jsx)("style",{dangerouslySetInnerHTML:{__html:d}}),(0,b.jsxs)("div",{className:"ann",children:["🌻 ",(0,b.jsx)("strong",{children:"Family-owned since 1958"})," · Three generations of the Wedgworth family · Sentricon® up to $1M coverage",(0,b.jsx)("a",{href:"tel:2056495278",children:"Call (205) 649-5278 →"})]}),(0,b.jsx)("nav",{children:(0,b.jsxs)("div",{className:"nav-inner",children:[(0,b.jsx)("div",{className:"logo-wrap",children:(0,b.jsx)("img",{id:"ec-logo",src:"/logo.png",alt:"EnviroCare Pest & Termite Services"})}),(0,b.jsxs)("ul",{className:"nav-links",children:[(0,b.jsx)("li",{children:(0,b.jsx)("a",{href:"/",children:"Home"})}),(0,b.jsx)("li",{children:(0,b.jsx)("a",{href:"/services",className:"active",children:"Services"})}),(0,b.jsx)("li",{children:(0,b.jsx)("a",{href:"/pricing",children:"Pricing"})}),(0,b.jsx)("li",{children:(0,b.jsx)("a",{href:"/why-envirocare",children:"Why EnviroCare"})}),(0,b.jsx)("li",{children:(0,b.jsx)("a",{href:"/contact",children:"Contact"})})]}),(0,b.jsxs)("div",{className:"nav-right",children:[(0,b.jsx)("a",{href:"tel:2056495278",className:"nav-phone",children:"(205) 649-5278"}),(0,b.jsx)("a",{href:"tel:2056495278",className:"nav-cta",children:"Get Free Quote"})]})]})}),(0,b.jsx)("section",{className:"page-hero",children:(0,b.jsxs)("div",{className:"page-hero-inner",children:[(0,b.jsx)("div",{className:"city-eyebrow",children:(0,b.jsx)("span",{className:"city-eyebrow-txt",children:"Every Service We Offer"})}),(0,b.jsxs)("h1",{children:["Four Pillars Plus",(0,b.jsx)("em",{children:"Specialty Service"})]}),(0,b.jsx)("p",{className:"page-hero-sub",children:"Bi-monthly pest control, Sentricon® termite protection with $1M coverage, mosquito and tick yard service — plus specialty options for fire ants, fleas, builders, real estate, crawlspaces, and commercial properties."}),(0,b.jsxs)("div",{className:"page-hero-cta",children:[(0,b.jsx)("a",{href:"tel:2056495278",className:"btn-gold",style:{overflow:"visible"},children:"Call (205) 649-5278"}),(0,b.jsx)("a",{href:"/pricing",className:"btn-outline-white",children:"See Pricing →"})]})]})}),(0,b.jsx)("div",{className:"trust",children:(0,b.jsxs)("div",{className:"trust-inner",children:[(0,b.jsxs)("div",{className:"ti",children:[(0,b.jsx)("div",{className:"ti-chk",children:"★"}),"4.9 Google · 500+ Reviews"]}),(0,b.jsxs)("div",{className:"ti",children:[(0,b.jsx)("div",{className:"ti-chk",children:"✓"}),"Sentricon® Certified Specialist"]}),(0,b.jsxs)("div",{className:"ti",children:[(0,b.jsx)("div",{className:"ti-chk",children:"✓"}),"Alabama Dept. of Ag. Licensed"]}),(0,b.jsxs)("div",{className:"ti",children:[(0,b.jsx)("div",{className:"ti-chk",children:"✓"}),"3rd-Generation Wedgworth Family"]})]})}),(0,b.jsx)("section",{className:"services-grid-section",children:(0,b.jsxs)("div",{className:"container",children:[(0,b.jsx)("div",{className:"section-eyebrow",children:"Core Services"}),(0,b.jsxs)("h2",{className:"section-title",children:["The ",(0,b.jsx)("span",{children:"Four Pillars"})]}),(0,b.jsx)("p",{className:"section-sub",children:"What every Alabama home should have. Bundle for convenience, never for forced discounts."}),(0,b.jsxs)("div",{className:"services-grid",children:[(0,b.jsxs)("div",{className:"svc-card feat",children:[(0,b.jsx)("div",{className:"svc-card-tag",children:"Most Popular"}),(0,b.jsx)("div",{className:"svc-card-name",children:"Pest Control"}),(0,b.jsx)("div",{className:"svc-card-price",children:"$35/mo ACH"}),(0,b.jsx)("div",{className:"svc-card-desc",children:"Bi-monthly perimeter service against ants, roaches, spiders & 30+ pests. Unlimited free re-services, no contracts."}),(0,b.jsx)("a",{href:"/services/pest-control",className:"svc-card-link",children:"Learn more →"})]}),(0,b.jsxs)("div",{className:"svc-card feat",children:[(0,b.jsx)("div",{className:"svc-card-tag",children:"Most Insurance"}),(0,b.jsx)("div",{className:"svc-card-name",children:"Termite Control"}),(0,b.jsx)("div",{className:"svc-card-price",children:"$32/mo · or $380 install + renewal"}),(0,b.jsx)("div",{className:"svc-card-desc",children:"Sentricon® Always Active™ bait stations. Up to $1,000,000 termite damage repair coverage. No drilling, no concrete cuts."}),(0,b.jsx)("a",{href:"/services/termite-control",className:"svc-card-link",children:"Learn more →"})]}),(0,b.jsxs)("div",{className:"svc-card",children:[(0,b.jsx)("div",{className:"svc-card-tag",children:"April – October"}),(0,b.jsx)("div",{className:"svc-card-name",children:"Mosquito Control"}),(0,b.jsx)("div",{className:"svc-card-price",children:"$45/mo · seasonal"}),(0,b.jsx)("div",{className:"svc-card-desc",children:"21-day yard barrier April through October. Pet- and kid-safe once dry. Make your patio livable again."}),(0,b.jsx)("a",{href:"/services/mosquito-control",className:"svc-card-link",children:"Learn more →"})]}),(0,b.jsxs)("div",{className:"svc-card",children:[(0,b.jsx)("div",{className:"svc-card-tag",children:"Bundles with Mosquito"}),(0,b.jsx)("div",{className:"svc-card-name",children:"Tick Control"}),(0,b.jsx)("div",{className:"svc-card-price",children:"Included in $60/mo Outdoor Bundle"}),(0,b.jsx)("div",{className:"svc-card-desc",children:"Targeted yard treatments for Lone Star, Dog, and Deer ticks. Critical for wooded lots and lake homes."}),(0,b.jsx)("a",{href:"/services/tick-control",className:"svc-card-link",children:"Learn more →"})]})]})]})}),(0,b.jsx)("section",{className:"services-grid-section",style:{background:"var(--white)"},children:(0,b.jsxs)("div",{className:"container",children:[(0,b.jsx)("div",{className:"section-eyebrow",children:"Specialty Services"}),(0,b.jsxs)("h2",{className:"section-title",children:["For ",(0,b.jsx)("span",{children:"Specific Needs"})]}),(0,b.jsx)("p",{className:"section-sub",children:"Targeted services for situations that need more than the standard program."}),(0,b.jsxs)("div",{className:"services-grid",children:[(0,b.jsxs)("div",{className:"svc-card",children:[(0,b.jsx)("div",{className:"svc-card-tag",children:"Lake & Suburban"}),(0,b.jsx)("div",{className:"svc-card-name",children:"Fire Ant Control"}),(0,b.jsx)("div",{className:"svc-card-desc",children:"Yard-wide elimination, not just spot mound treatment. Critical for barefoot summer and lakefront properties."}),(0,b.jsx)("a",{href:"/services/fire-ant",className:"svc-card-link",children:"Learn more →"})]}),(0,b.jsxs)("div",{className:"svc-card",children:[(0,b.jsx)("div",{className:"svc-card-tag",children:"Pet Households"}),(0,b.jsx)("div",{className:"svc-card-name",children:"Flea Control"}),(0,b.jsx)("div",{className:"svc-card-desc",children:"Yard barrier breaking the flea lifecycle. Bundles with mosquito and tick in the $60/mo Outdoor Bundle."}),(0,b.jsx)("a",{href:"/services/flea",className:"svc-card-link",children:"Learn more →"})]}),(0,b.jsxs)("div",{className:"svc-card",children:[(0,b.jsx)("div",{className:"svc-card-tag",children:"New Construction"}),(0,b.jsx)("div",{className:"svc-card-name",children:"Builder Pre-Treat"}),(0,b.jsx)("div",{className:"svc-card-desc",children:"Pre-slab termite treatment plus Sentricon® install. Coordinated with your construction schedule. Builder partnership pricing."}),(0,b.jsx)("a",{href:"/services/builder",className:"svc-card-link",children:"Learn more →"})]}),(0,b.jsxs)("div",{className:"svc-card",children:[(0,b.jsx)("div",{className:"svc-card-tag",children:"Closings"}),(0,b.jsx)("div",{className:"svc-card-name",children:"Real Estate / WDO Letters"}),(0,b.jsx)("div",{className:"svc-card-desc",children:"NPMA-33 inspection letters, lender-ready format, 48-hour turnaround. $75 standalone or free annually for active customers."}),(0,b.jsx)("a",{href:"/services/real-estate-wdo",className:"svc-card-link",children:"Learn more →"})]}),(0,b.jsxs)("div",{className:"svc-card",children:[(0,b.jsx)("div",{className:"svc-card-tag",children:"Foundation Care"}),(0,b.jsx)("div",{className:"svc-card-name",children:"Crawlspace Service"}),(0,b.jsx)("div",{className:"svc-card-desc",children:"Moisture control, vapor barrier installation, targeted pest treatment. Catches termite issues early."}),(0,b.jsx)("a",{href:"/services/crawlspace",className:"svc-card-link",children:"Learn more →"})]}),(0,b.jsxs)("div",{className:"svc-card",children:[(0,b.jsx)("div",{className:"svc-card-tag",children:"Business"}),(0,b.jsx)("div",{className:"svc-card-name",children:"Commercial Service"}),(0,b.jsx)("div",{className:"svc-card-desc",children:"IPM and HACCP programs for restaurants, offices, warehouses. Discrete scheduling, full audit-ready documentation."}),(0,b.jsx)("a",{href:"/services/commercial",className:"svc-card-link",children:"Learn more →"})]})]})]})}),(0,b.jsx)("section",{className:"office-cta",children:(0,b.jsxs)("div",{className:"office-cta-inner",children:[(0,b.jsx)("div",{className:"section-eyebrow",style:{color:"rgba(255,255,255,.7)"},children:"Not Sure Where To Start?"}),(0,b.jsx)("h3",{children:"Call A Real Person"}),(0,b.jsx)("div",{className:"office-cta-addr",children:"We\\'ll help you figure out what your home actually needs — no upsell pressure."}),(0,b.jsxs)("div",{className:"office-cta-row",children:[(0,b.jsx)("a",{href:"tel:2056495278",className:"btn-gold",style:{overflow:"visible"},children:"Call (205) 649-5278"}),(0,b.jsx)("a",{href:"/pricing",className:"btn-outline-white",children:"See Pricing →"})]})]})}),(0,b.jsxs)("footer",{id:"contact",children:[(0,b.jsxs)("div",{className:"footer-grid",children:[(0,b.jsx)("div",{children:(0,b.jsxs)("div",{className:"footer-brand",children:[(0,b.jsx)("strong",{children:"EnviroCare Pest & Termite Services"}),"Family-owned and operated since 1958 — third generation of the Wedgworth family. Three offices in Alabama.",(0,b.jsx)("br",{}),(0,b.jsx)("br",{}),(0,b.jsx)("a",{href:"tel:2056495278",className:"footer-phone",style:{fontSize:"1.05rem",fontWeight:700},children:"📞 (205) 649-5278 — Main"}),(0,b.jsx)("br",{}),(0,b.jsx)("a",{href:"tel:2059406360",className:"footer-phone",children:"📞 (205) 940-6360 — Birmingham"}),(0,b.jsx)("br",{}),(0,b.jsx)("a",{href:"tel:2562346162",className:"footer-phone",children:"📞 (256) 234-6162 — Lake Martin"}),(0,b.jsx)("br",{}),(0,b.jsx)("a",{href:"tel:2569377676",className:"footer-phone",children:"📞 (256) 937-7676 — Huntsville"})]})}),(0,b.jsxs)("div",{children:[(0,b.jsx)("div",{className:"footer-head",children:"Core Services"}),(0,b.jsxs)("ul",{className:"footer-links",children:[(0,b.jsx)("li",{children:(0,b.jsx)("a",{href:"/services/pest-control",children:"Pest Control"})}),(0,b.jsx)("li",{children:(0,b.jsx)("a",{href:"/services/termite-control",children:"Termite Control"})}),(0,b.jsx)("li",{children:(0,b.jsx)("a",{href:"/services/mosquito-control",children:"Mosquito Control"})}),(0,b.jsx)("li",{children:(0,b.jsx)("a",{href:"/services/tick-control",children:"Tick Control"})}),(0,b.jsx)("li",{children:(0,b.jsx)("a",{href:"/pricing",children:"Plans & Pricing"})})]})]}),(0,b.jsxs)("div",{children:[(0,b.jsx)("div",{className:"footer-head",children:"For Professionals"}),(0,b.jsxs)("ul",{className:"footer-links",children:[(0,b.jsx)("li",{children:(0,b.jsx)("a",{href:"/realtor",children:"For Realtors"})}),(0,b.jsx)("li",{children:(0,b.jsx)("a",{href:"/builders",children:"For Builders"})}),(0,b.jsx)("li",{children:(0,b.jsx)("a",{href:"/services/real-estate-wdo",children:"WDO Letters"})}),(0,b.jsx)("li",{children:(0,b.jsx)("a",{href:"/services/commercial",children:"Commercial"})}),(0,b.jsx)("li",{children:(0,b.jsx)("a",{href:"/faq",children:"FAQ"})})]})]}),(0,b.jsxs)("div",{children:[(0,b.jsx)("div",{className:"footer-head",children:"Service Areas"}),(0,b.jsxs)("ul",{className:"footer-links",children:[(0,b.jsx)("li",{children:(0,b.jsx)("a",{href:"/birmingham",children:"Birmingham, AL"})}),(0,b.jsx)("li",{children:(0,b.jsx)("a",{href:"/hoover",children:"Hoover, AL"})}),(0,b.jsx)("li",{children:(0,b.jsx)("a",{href:"/lake-martin",children:"Lake Martin, AL"})}),(0,b.jsx)("li",{children:(0,b.jsx)("a",{href:"/huntsville",children:"Huntsville, AL"})}),(0,b.jsx)("li",{children:(0,b.jsx)("a",{href:"/auburn",children:"Auburn, AL"})})]})]})]}),(0,b.jsxs)("div",{className:"footer-bottom",children:[(0,b.jsx)("span",{children:"© 2026 EnviroCare Pest & Termite Services LLC. All rights reserved. Licensed in Alabama · Sentricon® Certified Specialist"}),(0,b.jsxs)("div",{style:{display:"flex",gap:"1.5rem"},children:[(0,b.jsx)("a",{href:"/privacy",children:"Privacy"}),(0,b.jsx)("a",{href:"/terms",children:"Terms"}),(0,b.jsx)("a",{href:"/sitemap.xml",children:"Sitemap"})]})]})]})]})}])}];

//# sourceMappingURL=components_pages_ServicesIndexPage_tsx_02lqd2l._.js.map