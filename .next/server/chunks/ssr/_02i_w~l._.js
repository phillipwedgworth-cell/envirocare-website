module.exports=[80516,a=>{"use strict";a.s(["default",()=>b]);let b=(0,a.i(11857).registerClientReference)(function(){throw Error("Attempted to call the default export of [project]/components/BlogPostPage.tsx <module evaluation> from the server, but it's on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.")},"[project]/components/BlogPostPage.tsx <module evaluation>","default")},33535,a=>{"use strict";a.s(["default",()=>b]);let b=(0,a.i(11857).registerClientReference)(function(){throw Error("Attempted to call the default export of [project]/components/BlogPostPage.tsx from the server, but it's on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.")},"[project]/components/BlogPostPage.tsx","default")},2676,a=>{"use strict";a.i(80516);var b=a.i(33535);a.n(b)},52519,a=>{"use strict";var b=a.i(7997);let c=[{slug:"alabama-termite-swarm-season",title:"Why Alabama Termite Season Starts in March — And What to Watch For",excerpt:"Every March, subterranean termite swarmers emerge across Alabama. Here's how to spot them, why Birmingham's clay soil makes it worse, and what we recommend.",publishedAt:"2026-03-04",author:"Kevin Wedgworth",category:"Termites",readMinutes:6,heroEmoji:"🪵",metaTitle:"Alabama Termite Swarm Season Guide | EnviroCare Since 1958",metaDescription:"Alabama termite swarm season peaks March–May. Spot the signs, protect your home with Sentricon® $1M coverage. Free inspection. Call (205) 649-5278.",body:`
...
`}];var d=a.i(2676);async function e({params:a}){let{slug:b}=await a,d=c.find(a=>a.slug===b);return d?{title:d.metaTitle,description:d.metaDescription,openGraph:{title:d.metaTitle,description:d.metaDescription,type:"article",publishedTime:d.publishedAt,authors:[d.author]}}:{title:"Post Not Found | EnviroCare"}}async function f({params:a}){let{slug:c}=await a;return(0,b.jsx)(d.default,{slug:c})}a.s(["default",0,f,"generateMetadata",0,e,"generateStaticParams",0,function(){return[...c].sort((a,b)=>new Date(b.publishedAt).getTime()-new Date(a.publishedAt).getTime()).map(a=>({slug:a.slug}))}],52519)},90857,a=>{a.n(a.i(52519))}];

//# sourceMappingURL=_02i_w~l._.js.map