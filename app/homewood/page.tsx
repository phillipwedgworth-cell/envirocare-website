...
export const metadata: Metadata = {
  ...
  description:
    "Pest control, Sentricon® termite, mosquito & tick service in Homewood AL — Edgewood, Hollywood, West Homewood. From $35/mo. Call (205) 991-2882.",
...
const config: DeepCityConfig = {
  ...
  pressureCards: [
    ...
    { emoji: "🦟", title: "Mosquitoes off Shades Creek", body: "Shades Creek and the Lakeshore corridor keep mosquito pressure up from March through October. The 30-day yard barrier keeps porches and small city yards usable through the season." },
  ...
  services: [
    { title: "Termite Treatment in Homewood", body: (<>Homewood&apos;s historic bungalows make subterranean termites a year-round concern. EnviroCare protects with the{" "}<Link href="/services/termite-control" style={{ color: G, fontWeight: 600 }}>Sentricon® baiting system</Link> — no drilling into your foundation or slab. Sentricon® is priced after a free on-site WDO inspection — with coverage up to $1,000,000 subject to the terms of the agreement.{" "}<Link href="/services/wdo-letters" style={{ color: G, fontWeight: 600 }}>Termite-letter (WDO) inspections</Link> for Homewood home sales are available for closings.</>) },
    { title: "Mosquito Control in Homewood", body: (<>The Shades Creek corridor holds mosquito pressure spring into fall.{" "}<Link href="/services/mosquito" style={{ color: G, fontWeight: 600 }}>Mosquito control</Link> treats every 30 days, March through October — eight treatments at $45/month, spread evenly across the year by ACH. We never guarantee elimination, but most homeowners see a clear difference in how usable the yard becomes.</>) },
    { title: "Tick Control in Homewood", body: (<>Yards along the Shades Creek greenway put ticks close to families and pets. EnviroCare&apos;s{" "}<Link href="/services/tick-control" style={{ color: G, fontWeight: 600 }}>mosquito-plus-tick program</Link> adds tick and chigger coverage — $65 per month. Most products knock back tick activity in treated zones; results vary with yard conditions.</>) },
    ...
    { title: "Commercial Pest Control in Homewood", body: (<>EnviroCare services{" "}<Link href="/services/commercial" style={{ color: G, fontWeight: 600 }}>commercial properties</Link> across Homewood — the 18th Street and SoHo restaurants, retail, and offices — on schedules built around your hours and foot traffic, documented for health-inspection readiness. Call (205)&nbsp;991-2882 for a walkthrough.</>) },
  ],
  faqs: [
    { q: "How much is termite treatment in Homewood?", a: "EnviroCare termite protection in Homewood is priced after a free on-site WDO inspection. It uses the Sentricon baiting system with no drilling, with coverage up to $1,000,000 subject to the terms of the agreement." },
    { q: "Is there mosquito control in Homewood?", a: "Yes. EnviroCare treats Homewood yards every 30 days from March through October — eight treatments at $45/month, spread evenly across the year by ACH. Most homeowners see a clear seasonal reduction in mosquito activity." },
    ...
    { q: "Do you serve Edgewood, Hollywood, West Homewood, and SoHo?", a: "Yes — all of Homewood. Call (205) 991-2882 and we'll confirm your address is on our route." },
  ],
  siblings: [
