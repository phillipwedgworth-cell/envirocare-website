...
const config: DeepCityConfig = {
  ...
  pressureCards: [
    ...
    { emoji: "🐾", title: "Ticks on the Shades Creek greenway", body: "Yards backing up to the Shades Creek greenway and Lakeshore trail carry Lone Star and dog ticks. Tick and chigger coverage bundles with mosquito in the Outdoor Pro plan." },
  ],
  services: [
    { title: "Termite Treatment in Homewood", body: (<>Homewood&apos;s historic bungalows make subterranean termites a year-round concern. EnviroCare protects with the{" "}<Link href="/services/termite-control" style={{ color: G, fontWeight: 600 }}>Sentricon® baiting system</Link> — no drilling into your foundation or slab. Installation is $325 (first-year guarantee included); renewal is $380/year, or $32/month, with coverage up to $1,000,000 backed by EnviroCare&apos;s own guarantee.{" "}<Link href="/services/wdo-letters" style={{ color: G, fontWeight: 600 }}>Termite-letter (WDO) inspections</Link> for Homewood home sales are available for closings.</>) },
  ...
  faqs: [
    { q: "How much is termite treatment in Homewood?", a: "EnviroCare termite protection in Homewood is $325 to install (first-year guarantee included) and $380 per year to renew, or $32 per month. It uses the Sentricon baiting system with no drilling, with coverage up to $1,000,000 backed by EnviroCare's guarantee." },
