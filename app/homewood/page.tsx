...
const config: DeepCityConfig = {
  ...
  faqs: [
    ...
    { q: "Is there mosquito control in Homewood?", a: "Yes. EnviroCare treats Homewood yards every 30 days from March through October — eight treatments at $45 each, about $30 per month over the year. Most homeowners see a clear seasonal reduction in mosquito activity." },
