...
const config: DeepCityConfig = {
  ...
  services: [
    ...
    { title: "Ant Control in Homewood", body: (<>Carpenter, odorous house, and pavement ants are among Homewood&apos;s most common calls. The bi-monthly pest plan covers 30+ pests including most household ants, with unlimited re-service at no extra charge. All products are EPA-registered and applied per label directions.{" "}<Link href="/services/fire-ant" style={{ color: G, fontWeight: 600 }}>Fire ants</Link> are priced separately by treated area.</>) },
  ...
  faqs: [
    ...
    { q: "What does bi-monthly pest control cover in Homewood?", a: "EnviroCare's bi-monthly plan is $35 per month and covers 30+ common household pests including most ants, spiders, and roaches, with unlimited re-service between regular visits at no extra charge. Fire ant, flea, and tick are priced separately." },
