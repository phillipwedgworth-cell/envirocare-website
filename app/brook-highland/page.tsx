...
export const metadata: Metadata = {
  title: "Pest Control Brook Highland, Hoover AL | Sentricon® Termite | EnviroCare — Since 1958",
  ...
  "@graph": [
    {
      ...
      "name": "EnviroCare Pest & Termite Services — Brook Highland",
      ...
      "priceRange": "$",
      "description": "Family-owned pest, termite, mosquito and tick service for Brook Highland, Hoover. Sentricon® Certified Specialist. EPA-registered products applied to label directions. Wedgworth family, third generation since 1958."
    },
    {
      "@type": "Service",
