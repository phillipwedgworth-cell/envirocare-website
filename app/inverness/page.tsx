...
const config: DeepCityConfig = {
  ...
  pressureCards: [
    { emoji: "🪵", title: "Termites in established homes", body: "Inverness's mature, settled foundations are exactly what Eastern subterranean termites work toward. EnviroCare protects with Sentricon® — no drilling — up to $1,000,000 in coverage subject to the terms of the agreement." },
    { emoji: "🦟", title: "Mosquitoes off Lake Heather & the ponds", body: "Lake Heather, neighborhood ponds, and irrigated lots hold the standing water and shade mosquitoes breed in. The 30-day yard barrier treats March through October." },
  ...
  faqs: [
    ...
    { q: "Is there mosquito control in Inverness?", a: "Yes. EnviroCare treats Inverness yards every 30 days from March through October — eight treatments at $45 each, about $30 per month. Most homeowners see a clear seasonal reduction in mosquito activity." },
