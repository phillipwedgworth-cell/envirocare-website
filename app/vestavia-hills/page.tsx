...
const config: DeepCityConfig = {
  ...
  summary:
    "EnviroCare provides pest control, termite protection, mosquito, and tick service in Vestavia Hills, Alabama, including Cahaba Heights, Rocky Ridge, Liberty Park, and Vestavia East. Bi-monthly pest control is $35/month and covers 30+ common household pests — including ants, spiders, and roaches — with unlimited re-service between visits. Termite protection uses the Sentricon® baiting system with no drilling, backed by EnviroCare's guarantee of up to $1,000,000 in property coverage. A family-owned Alabama company, EnviroCare has protected homes since 1958. Call (205) 940-6360.",
  ...
  services: [
    ...
    },
    {
      ...
      body: (
        <>
          Odorous house ants, carpenter ants, and Argentine ants are among Vestavia&apos;s most common calls. The bi-monthly pest plan covers 30+ pests including most household ants, with unlimited re-service if they return between visits, at no extra charge. All products are EPA-registered and applied per label directions.{" "}
  ...
  faqs: [
    ...
    { q: "What does bi-monthly pest control cover in Vestavia Hills?", a: "EnviroCare's bi-monthly plan is $35 per month and covers 30+ common household pests including most ants, spiders, and roaches, with unlimited re-service between regular visits at no extra charge. Fire ant, flea, and tick are priced separately." },
