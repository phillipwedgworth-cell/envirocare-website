...
export const metadata: Metadata = {
  title: "Pest Control Cherokee Bend, Mountain Brook AL | Sentricon® Termite | EnviroCare — Since 1958",
  description: "Family-owned pest, Sentricon® termite, and mosquito service for Cherokee Bend homes. No drilling, $1M termite coverage, no long-term contracts. Call (205) 940-6360.",
...
const cfg: NeighborhoodConfig = {
  ...
  pressureCards: [
    ...
    },
    {
      ...
      body: "Cherokee Bend's mid-century ranch and split-level homes often sit on crawlspaces over moisture-holding soil — classic Eastern subterranean termite conditions. Sentricon® Always Active™ protects with in-ground bait stations, no drilling, and up to $1M in coverage under EnviroCare's own guarantee.",
    },
    {
      emoji: "🕷️",
  ...
  "@graph": [
    {
      ...
      name: "EnviroCare Pest & Termite Services — Cherokee Bend",
