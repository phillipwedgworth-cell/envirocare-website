...
const config: DeepCityConfig = {
  ...
  faqs: [
    ...
    { q: "Do you treat ticks and mosquitoes in Ballantrae?", a: "Yes. The Mosquito + Tick program (chiggers covered) treats every 30 days, March through October, for $65 per visit — built for the Oak Mountain tree line and fairway ponds." },
