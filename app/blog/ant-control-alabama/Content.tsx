...
export default function AntControlContent() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#FEFDF8", fontFamily: "'DM Sans', system-ui, sans-serif" }}>
      <section style={{ background: `linear-gradient(160deg, ${DARK}, #1a3a2a)`, color: "#fff", padding: "72px 40px 64px", position: "relative", overflow: "hidden" }}>
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          ...
          <h1 style={{ fontSize: "clamp(34px,4.5vw,58px)", fontWeight: 400, lineHeight: 1.1, marginBottom: 6, fontFamily: "'Playfair Display', Georgia, serif" }}>Ant Control</h1>
          <h1 style={{ fontSize: "clamp(34px,4.5vw,58px)", fontWeight: 700, lineHeight: 1.1, marginBottom: 22, color: GOLD, fontFamily: "'Playfair Display', Georgia, serif" }}>Alabama Specialists.</h1>
      ...
      <section style={{ padding: "72px 40px", background: "#f7f9f7" }}>
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          <h2 style={{ fontSize: 28, fontWeight: 400, color: DARK, textAlign: "center", marginBottom: 40, fontFamily: "'Playfair Display', Georgia, serif" }}>Ants in <em style={{ color: G }}>Alabama</em></h2>
      ...
      <section style={{ padding: "64px 40px", background: `linear-gradient(160deg, ${DARK}, #1a3a2a)`, color: "#fff" }}>
        <div style={{ maxWidth: 700, margin: "0 auto" }}>
          <h2 style={{ fontSize: 24, fontWeight: 400, marginBottom: 20, fontFamily: "'Playfair Display', Georgia, serif" }}>How We Treat <em style={{ color: GOLD }}>Ants</em></h2>
      ...
      <section style={{ background: "#FEFDF8", padding: "56px 40px" }}>
        <div style={{ maxWidth: 680, margin: "0 auto" }}>
          <h2 style={{ fontSize: 26, fontWeight: 400, color: DARK, marginBottom: 28, textAlign: "center", fontFamily: "'Playfair Display', Georgia, serif" }}>Ant FAQ</h2>
      ...
      <section style={{ background: `linear-gradient(160deg, ${G}, #0d3a1a)`, padding: "56px 40px", textAlign: "center", color: "#fff" }}>
        <div style={{ maxWidth: 520, margin: "0 auto" }}>
          <h2 style={{ fontSize: 32, fontWeight: 400, lineHeight: 1.2, marginBottom: 12, fontFamily: "'Playfair Display', Georgia, serif" }}>Stop Ants <em>For Good</em></h2>
