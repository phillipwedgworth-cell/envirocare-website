...
export const metadata: Metadata = {
  title: "Pest Control Indian Springs Village AL | Sentricon® Termite | EnviroCare — Since 1958",
  description: "Family-owned pest, Sentricon® termite, and mosquito service for Indian Springs Village homes. No drilling, $1M coverage, no long-term contracts. Call (205) 940-6360.",
...
const cfg: NeighborhoodConfig = {
  ...
  "heroIntro": "Bi-monthly perimeter service, no-drilling Sentricon® termite protection, and seasonal Outdoor Pro mosquito + tick treatment for every home on the ridge.",
  ...
  "pressureCards": [
    {
      ...
      "body": "Indian Springs Village is essentially a residential community built into the Cahaba River watershed's wooded ridge. That's beautiful — and it's also why the Lone Star tick, American dog tick, and chigger pressure here is among the highest in the metro. Outdoor Pro plan ($65/treatment) bundles all three plus mosquito coverage."
    },
    {
      "emoji": "🦟",
  ...
  "@graph": [
    {
      ...
      "priceRange": "$",
      "description": "Family-owned pest, termite, mosquito and tick service for Indian Springs Village, Shelby County. Sentricon® Certified Specialist. EPA-registered products applied to label directions. Wedgworth family, third generation since 1958."
    },
    {
      "@type": "Service",
