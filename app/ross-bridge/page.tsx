...
const config: DeepCityConfig = {
  ...
  services: [
    ...
    { title: "Mosquito Control in Ross Bridge", body: (<>The resort lakes, fountains, and golf water features hold standing water all season — the reason the walkable village and back patios need protection. <Link href="/services/mosquito" style={{ color: G, fontWeight: 600 }}>Mosquito control</Link> treats every 30 days, March through October, at $45 a visit.</>) },
    { title: "Tick Control in Ross Bridge", body: (<>The wooded greenways and cart-path tree lines carry Lone Star and dog ticks. The <Link href="/services/tick-control" style={{ color: G, fontWeight: 600 }}>Mosquito + Tick program</Link> adds tick and chigger coverage at $65 a visit.</>) },
  ...
  faqs: [
    ...
    { q: "Is there mosquito control in Ross Bridge?", a: "Yes. EnviroCare treats Ross Bridge yards every 30 days from March through October — eight treatments at $45 each, about $30 per month. Most homeowners see a clear seasonal reduction in mosquito activity." },
