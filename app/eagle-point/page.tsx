  ...
  "@graph": [
    {
      ...
      "priceRange": "$",
      "description": "Family-owned pest, termite, mosquito and tick service for Eagle Point, Hoover. Sentricon® Certified Specialist. EPA-registered products applied to label directions. Wedgworth family, third generation since 1958."
    },
    {
      "@type": "Service",
