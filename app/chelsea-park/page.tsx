...
const config: DeepCityConfig = {
  ...
  services: [
    ...
    { title: "Mosquito Control in Chelsea Park", body: (<>The community lakes, pool area, and rolling wet-weather drainages breed mosquitoes March through October. <Link href="/services/mosquito" style={{ color: G, fontWeight: 600 }}>Mosquito control</Link> treats the yard barrier every 30 days at $45 a visit — built to keep decks and playsets usable.</>) },
  ...
  faqs: [
    ...
    { q: "Is there mosquito control in Chelsea Park?", a: "Yes. EnviroCare treats Chelsea Park yards every 30 days from March through October — eight treatments at $45 each, about $30 per month. Most homeowners see a clear seasonal reduction in mosquito activity." },
