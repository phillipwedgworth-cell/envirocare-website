...
const config: DeepCityConfig = {
  ...
  pressureCards: [
    ...
    { emoji: "🦟", title: "Mosquitoes off the community lakes", body: "Chelsea Park's lakes and rolling drainages hold the standing water mosquitoes breed in from March through October. The 30-day yard barrier keeps decks and playsets usable all season." },
  ...
  services: [
    ...
    { title: "Mosquito Control in Chelsea Park", body: (<>The community lakes, pool area, and rolling wet-weather drainages breed mosquitoes March through October. <Link href="/services/mosquito" style={{ color: G, fontWeight: 600 }}>Mosquito control</Link> treats the yard barrier every 30 days at $45 a month — built to keep decks and playsets usable.</>) },
    { title: "Tick Control in Chelsea Park", body: (<>The rolling wooded lots and trail edges around Chelsea Park carry Lone Star and dog ticks. The <Link href="/services/tick-control" style={{ color: G, fontWeight: 600 }}>Mosquito + Tick program</Link> adds tick and chigger coverage at $65 a month.</>) },
  ...
  faqs: [
    ...
    { q: "Is there mosquito control in Chelsea Park?", a: "Yes. EnviroCare treats Chelsea Park yards every 30 days from March through October — eight treatments at $45/month, spread evenly across the year by ACH. Most homeowners see a clear seasonal reduction in mosquito activity." },
