...
const config: DeepCityConfig = {
  ...
  services: [
    ...
    { title: "Ant & Pest Control in Hoover", body: (<>Carpenter, odorous house, and Argentine ants are common across Hoover. The bi-monthly pest plan covers 30+ pests including most household ants, with unlimited re-service at no extra charge.{" "}<Link href="/services/fire-ant" style={{ color: G, fontWeight: 600 }}>Fire ants</Link> in new-construction yards are priced separately by treated area.</>) },
  ],
  faqs: [
    { q: "How much is pest control in Hoover?", a: "EnviroCare's bi-monthly plan is $35 per month on ACH (or $70 per visit) and covers 30+ common pests including ants, spiders, and roaches, with unlimited free re-service between visits. No long-term contract." },
