...
const config: DeepCityConfig = {
  ...
  faqs: [
    ...
    { q: "Do you treat ticks in Hoover?", a: "Yes — the mosquito-plus-tick program adds tick and chigger coverage for $65 per treatment (about $43.33/month across the season), targeting the wooded lots in Bluff Park, Inverness, and Ross Bridge." },
