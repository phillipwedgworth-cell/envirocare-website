...
const FAQ_SCHEMA = {
  ...
  mainEntity: [
    ...
    { "@type": "Question", name: "Can I get mosquito or tick without a pest plan?", acceptedAnswer: { "@type": "Answer", text: "Yes — mosquito alone is $45 per month and mosquito + tick is $65 per month, eight rounds March through October, charged at each service. Tick is only offered alongside mosquito." } },
