...
const config: DeepCityConfig = {
  ...
  pressureCards: [
    ...
    { emoji: "🦟", title: "Mosquitoes in Dunnavant Valley", body: "Shaded valley lots and creek drainage keep mosquito pressure high March through October. The 30-day yard barrier keeps trails, porches, and play areas usable through the season." },
  ...
  services: [
    ...
    { title: "Tick Control in Mt Laurel", body: (<>Homes carved into deep forest sit right against tick habitat. EnviroCare&apos;s{" "}<Link href="/services/tick-control" style={{ color: G, fontWeight: 600 }}>mosquito-plus-tick program</Link> adds tick and chigger coverage — $65 per month. Most products knock back tick activity in treated zones; results vary with surrounding habitat.</>) },
  ...
  faqs: [
    ...
    { q: "Do you treat ticks and mosquitoes in Mt Laurel?", a: "Yes — the Mosquito + Tick mosquito + tick program runs every 30 days, March through October, for $65 per month, built for Mt Laurel's wooded, woodland-edge lots." },
