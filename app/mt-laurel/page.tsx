...
const config: DeepCityConfig = {
  ...
  services: [
    { title: "Termite Treatment in Mt Laurel", body: (<>The damp, wooded soil around Mt Laurel keeps subterranean termites active year-round. EnviroCare protects with the{" "}<Link href="/services/termite-control" style={{ color: G, fontWeight: 600 }}>Sentricon® baiting system</Link> — no drilling into your foundation or slab. Installation is $325 (first-year guarantee included); renewal is $380/year, or $32/month, with coverage up to $1,000,000 backed by EnviroCare&apos;s own guarantee.{" "}<Link href="/services/wdo-letters" style={{ color: G, fontWeight: 600 }}>WDO termite letters</Link> for home sales available.</>) },
