...
const config: DeepCityConfig = {
  ...
  faqs: [
    ...
    { q: "Do you treat ticks and mosquitoes in Mt Laurel?", a: "Yes — the Mosquito + Tick mosquito + tick program runs every 30 days, March through October, for $65 per treatment (about $43.33/month), built for Mt Laurel's wooded, woodland-edge lots." },
