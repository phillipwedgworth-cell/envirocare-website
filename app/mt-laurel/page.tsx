...
const config: DeepCityConfig = {
  ...
  services: [
    { title: "Termite Treatment in Mt Laurel", body: (<>The damp, wooded soil around Mt Laurel keeps subterranean termites active year-round. EnviroCare protects with the{" "}<Link href="/services/termite-control" style={{ color: G, fontWeight: 600 }}>Sentricon® baiting system</Link> — no drilling into your foundation or slab. Sentricon® is priced after a free on-site WDO inspection — with coverage up to $1,000,000 backed by EnviroCare&apos;s own guarantee.{" "}<Link href="/services/wdo-letters" style={{ color: G, fontWeight: 600 }}>WDO termite letters</Link> for home sales available.</>) },
    ...
    { title: "Ant Control in Mt Laurel", body: (<>Carpenter and odorous house ants come in from the surrounding woods. The bi-monthly pest plan covers 30+ pests including most household ants, with unlimited re-service at no extra charge.{" "}<Link href="/services/fire-ant" style={{ color: G, fontWeight: 600 }}>Fire ants</Link> are priced separately by treated area.</>) },
  ...
  faqs: [
    ...
    { q: "What does bi-monthly pest control cover in Mt Laurel?", a: "EnviroCare's bi-monthly plan is $35 per month and covers 30+ common household pests including most ants, spiders, and roaches, with unlimited re-service between regular visits at no extra charge. Fire ant, flea, and tick are priced separately." },
