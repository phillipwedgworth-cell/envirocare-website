...
// Commit: fix(fonts): use font tokens, drop Google Fonts loader
// Push: main
// ───────────────────────────────────
    ...
    <>
      ...
      <section className="not-found-hero">
        <div>
          ...
          <div className="not-found-links">
            ...
            <a href="/services" className="nf-link">
              <div className="nf-link-label">All Services</div>
              <div className="nf-link-title">Services</div>
            </a>
            <a href="/faq" className="nf-link">
              <div className="nf-link-label">Common Questions</div>
              <div className="nf-link-title">FAQ</div>
            </a>
          </div>
        </div>
      </section>
      ...
      <footer id="contact">
        <div className="footer-grid">
          ...
          <div><div className="footer-head">Cities</div><ul className="footer-links">
            <li><a href="/birmingham">Birmingham</a></li><li><a href="/huntsville">Huntsville</a></li><li><a href="/lake-martin">Lake Martin</a></li><li><a href="/auburn">Auburn</a></li>
          </ul></div>
        </div>
