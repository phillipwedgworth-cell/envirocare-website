...
const config: DeepCityConfig = {
  ...
  services: [
    ...
    { title: "Tick Control in Trussville", body: (<>Wooded lots in Carrington and Stockton and along the river put ticks close to families and pets. EnviroCare&apos;s{" "}<Link href="/services/tick-control" style={{ color: G, fontWeight: 600 }}>mosquito-plus-tick program</Link> adds tick and chigger coverage — $65 per month. Most products knock back tick activity in treated zones; results vary with habitat.</>) },
  ...
  faqs: [
    ...
    { q: "Is there mosquito control in Trussville?", a: "Yes. EnviroCare treats Trussville yards every 30 days from March through October — eight treatments at $45/month, spread evenly across the year by ACH. Most homeowners see a clear seasonal reduction in mosquito activity." },
