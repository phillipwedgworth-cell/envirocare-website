...
const config: DeepCityConfig = {
  ...
  services: [
    ...
    { title: "Ant Control in Trussville", body: (<>Carpenter and odorous house ants come off the tree canopy. The bi-monthly pest plan covers 30+ pests including most household ants, with unlimited re-service at no extra charge.{" "}<Link href="/services/fire-ant" style={{ color: G, fontWeight: 600 }}>Fire ants</Link> in newer subdivisions are priced separately by treated area.</>) },
  ...
  faqs: [
    ...
    { q: "What does bi-monthly pest control cover in Trussville?", a: "EnviroCare's bi-monthly plan is $35 per month and covers 30+ common household pests including most ants, spiders, and roaches, with unlimited re-service between regular visits at no extra charge. Fire ant, flea, and tick are priced separately." },
