...
export const metadata = {
  ...
  description: 'Sentricon termite protection in Birmingham, AL — no drilling, coverage with up to $1M in damage repair coverage, subject to the terms of the agreement. Free WDO inspection. Call (205) 940-6360.',
  openGraph: {
    title: 'Termite Control Birmingham AL | Sentricon® | EnviroCare',
    description: 'Sentricon termite protection in Birmingham, AL — no drilling, coverage with up to $1M in damage repair coverage, subject to the terms of the agreement. Free WDO inspection. Call (205) 940-6360.',
