...
export const metadata = {
  ...
  description: 'Sentricon® termite protection in Birmingham, AL — in-ground bait stations, no drilling, free WDO inspection. Family-owned since 1958. Call (205) 940-6360.',
  openGraph: {
    title: 'Termite Control Birmingham AL | Sentricon® | EnviroCare',
    description: 'Sentricon® termite protection in Birmingham, AL — in-ground bait stations, no drilling, free WDO inspection. Family-owned since 1958. Call (205) 940-6360.',
