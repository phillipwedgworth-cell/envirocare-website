...
const config: DeepCityConfig = {
  ...
  faqs: [
    ...
    { q: "Is there mosquito control in Chelsea?", a: "Yes. EnviroCare treats Chelsea yards every 30 days from March through October — eight treatments at $45 each, about $30 per month. Most homeowners see a clear seasonal reduction in mosquito activity." },
