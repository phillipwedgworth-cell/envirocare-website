...
const config: DeepCityConfig = {
  ...
  pressureCards: [
    ...
    { emoji: "🦟", title: "Mosquitoes off the creeks", body: "Wooded lots and creek drainage across Chelsea hold the standing water mosquitoes breed in March through October. The 30-day yard barrier keeps yards usable through the season." },
  ...
  services: [
    ...
    { title: "Tick Control in Chelsea", body: (<>Foothill tree lines and Westover's wooded lots put ticks close to families and pets. EnviroCare&apos;s{" "}<Link href="/services/tick-control" style={{ color: G, fontWeight: 600 }}>mosquito-plus-tick program</Link> adds tick and chigger coverage — $65 per month. Most products knock back tick activity in treated zones; results vary with habitat.</>) },
  ...
  faqs: [
    ...
    { q: "Is there mosquito control in Chelsea?", a: "Yes. EnviroCare treats Chelsea yards every 30 days from March through October — eight treatments at $45/month, spread evenly across the year by ACH. Most homeowners see a clear seasonal reduction in mosquito activity." },
