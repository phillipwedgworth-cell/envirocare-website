...
const config: DeepCityConfig = {
  ...
  faqs: [
    ...
    { q: "How much is termite treatment in Chelsea?", a: "Termite protection is $325 to install (first-year guarantee included) and $380 per year to renew, or $32 per month, using Sentricon baiting with no drilling and coverage up to $1,000,000 backed by EnviroCare's guarantee." },
