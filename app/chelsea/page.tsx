...
const config: DeepCityConfig = {
  ...
  services: [
    ...
    { title: "Ant & Fire Ant Control in Chelsea", body: (<>Carpenter and odorous house ants come in from the woods; the bi-monthly pest plan covers 30+ pests including most household ants, with unlimited re-service at no extra charge.{" "}<Link href="/services/fire-ant" style={{ color: G, fontWeight: 600 }}>Fire ants</Link> in fresh sod are priced separately by treated area.</>) },
  ...
  faqs: [
    ...
    { q: "What does bi-monthly pest control cover in Chelsea?", a: "EnviroCare's bi-monthly plan is $35 per month and covers 30+ common household pests including most ants, spiders, and roaches, with unlimited re-service between regular visits at no extra charge. Fire ant, flea, and tick are priced separately." },
