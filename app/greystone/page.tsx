...
const config: DeepCityConfig = {
  ...
  services: [
    ...
    { title: "Ant Control in Greystone", body: (<>Carpenter and odorous house ants come off the landscaped tree line. The bi-monthly pest plan covers 30+ pests including most household ants, with unlimited re-service at no extra charge.{" "}<Link href="/services/fire-ant" style={{ color: G, fontWeight: 600 }}>Fire ants</Link> on fairway-edge turf are priced separately by treated area.</>) },
  ...
  faqs: [
    { q: "How much is termite treatment in Greystone?", a: "EnviroCare termite protection in Greystone is priced after a free on-site WDO inspection. It uses Sentricon baiting with no drilling, with coverage up to $1,000,000 backed by EnviroCare's guarantee." },
    { q: "Can you protect a Greystone home from termites without drilling?", a: "Yes. Sentricon® Always Active™ uses in-ground bait stations around the home — no drilling, no trenching, no disruption to your landscaping — with up to $1M coverage under EnviroCare's own guarantee. The inspection is free." },
    ...
    { q: "What does bi-monthly pest control cover in Greystone?", a: "EnviroCare's bi-monthly plan is $35 per month and covers 30+ common household pests including most ants, spiders, and roaches, with unlimited re-service between regular visits at no extra charge. Fire ant, flea, and tick are priced separately." },
