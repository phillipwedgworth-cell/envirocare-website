...
const config: DeepCityConfig = {
  ...
  pressureCards: [
    ...
    { emoji: "🦟", title: "Mosquitoes off the course & ponds", body: "Golf-course corridors, ponds, and wooded lots hold the standing water and shade mosquitoes breed in. The 30-day yard barrier treats March through October." },
  ...
  services: [
    ...
    { title: "Tick Control in Greystone", body: (<>The wooded edges between fairways and homes carry Lone Star and dog ticks. EnviroCare&apos;s{" "}<Link href="/services/tick-control" style={{ color: G, fontWeight: 600 }}>mosquito-plus-tick program</Link> adds tick and chigger coverage — $65 per month. Most products knock back tick activity in treated zones; results vary with habitat.</>) },
  ...
  faqs: [
    ...
    { q: "Is there mosquito control in Greystone?", a: "Yes. EnviroCare treats Greystone yards every 30 days from March through October — eight treatments at $45/month, spread evenly across the year by ACH. Most homeowners see a clear seasonal reduction in mosquito activity." },
