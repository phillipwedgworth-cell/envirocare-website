...
export const metadata: Metadata = {
  ...
  description:
    "Pest control, Sentricon® termite, mosquito & tick service for Greystone homes in Hoover AL — Founders, Legacy. From $35/mo. Call (205) 991-2882.",
...
const config: DeepCityConfig = {
  ...
  services: [
    ...
    { title: "Commercial Pest Control in Greystone", body: (<>EnviroCare services{" "}<Link href="/services/commercial" style={{ color: G, fontWeight: 600 }}>commercial properties</Link> around Greystone — the country club, clubhouses, and HOA common areas — with documented, inspection-ready service on schedules built around your hours. Call (205)&nbsp;991-2882 for a walkthrough.</>) },
  ],
  faqs: [
    ...
    { q: "Do you serve Greystone Founders, Legacy, and Farms?", a: "Yes — all of Greystone. Call (205) 991-2882 and we'll confirm your address is on our route." },
  ],
  siblings: [
