...
const config: DeepCityConfig = {
  ...
  services: [
    { title: "Termite Treatment in Greystone", body: (<>These are the homes Sentricon® was built for — custom foundations and landscaping nobody wants drilled into. EnviroCare protects with the{" "}<Link href="/services/termite-control" style={{ color: G, fontWeight: 600 }}>Sentricon® baiting system</Link>: in-ground stations, no drilling, no trenching. Installation is $325 (first-year guarantee included); renewal is $380/year, or $32/month, with up to $1,000,000 in coverage under EnviroCare&apos;s own guarantee.{" "}<Link href="/services/wdo-letters" style={{ color: G, fontWeight: 600 }}>WDO termite letters</Link> for home sales available.</>) },
  ...
  faqs: [
    { q: "How much is termite treatment in Greystone?", a: "EnviroCare termite protection in Greystone is $325 to install (first-year guarantee included) and $380 per year to renew, or $32 per month. It uses Sentricon baiting with no drilling, with coverage up to $1,000,000 backed by EnviroCare's guarantee." },
