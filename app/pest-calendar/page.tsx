...
export const metadata = {
  ...
  description: 'Alabama pest activity by month. Termites in March, mosquitoes March–November, rodents in fall. What\'s in your yard right now? Free inspection. Call (205) 649-5278.',
};
