...
export const metadata: Metadata = {
  title: "Pest Control Crestline, Mountain Brook AL | Sentricon® Termite | EnviroCare — Since 1958",
...
const cfg: NeighborhoodConfig = {
  ...
  faqs: [
    ...
    },
    {
      ...
      a: "No. Pest control is month-to-month on ACH and you can cancel anytime. We'd rather earn the next visit than lock you in.",
    },
  ],
  nearby: [
  ...
  "@graph": [
    {
      ...
      name: "EnviroCare Pest & Termite Services — Crestline",
