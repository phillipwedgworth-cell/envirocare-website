    ...
    },
    {
      ...
      mainEntity: [
        ...
        },
        {
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text: "Mosquito service is $45 per treatment, applied monthly March through November (9 treatments per year, ~$33.75/month equivalent). If you also want tick coverage — which is worth it on any wooded Fultondale lot — the combined Mosquito + Tick plan is $65 per treatment.",
          },
        },
        {
          "@type": "Question",
        ...
        },
        {
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text: "Yes — same office, same technicians. Sentricon® termite protection (Sentricon® priced after a free WDO inspection — up to $1M EnviroCare-backed damage coverage). Bi-monthly exterior pest control ($35/mo) covering ants, spiders, roaches, and 30+ common Alabama pests with unlimited free re-services.",
          },
        },
        {
          "@type": "Question",
      ...
      <main style={{ background: "#fff", color: Ik, ...sans }}>
        ...
        <section style={{ padding: "5rem clamp(1.5rem,5vw,4rem)", background: Cr, borderTop: `1px solid ${G}22` }}>
          <div style={{ maxWidth: 880, margin: "0 auto" }}>
            ...
            <Faq q="Do you also handle termites and general pest control in Fultondale?" a="Yes — same office, same technicians. Sentricon® termite protection (Sentricon® priced after a free WDO inspection — up to $1M EnviroCare-backed damage coverage). Bi-monthly exterior pest control ($35/mo) covering ants, spiders, roaches, and 30+ common Alabama pests with unlimited free re-services." />
