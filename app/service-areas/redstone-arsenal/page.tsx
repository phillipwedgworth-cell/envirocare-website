...
export default function RedstoneArsenalPage() {
  return (
    <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({ "@context": "https://schema.org", ...breadcrumbList([{ name: 'Service Areas', path: '/service-areas' }, { name: 'Redstone Arsenal', path: '/service-areas/redstone-arsenal' }]) }) }} />
        ...
        <section style={{ padding: "5rem clamp(1.5rem,5vw,4rem)", background: Cr }}>
          <div style={{ maxWidth: 1100, margin: "0 auto" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(260px,1fr))", gap: "1.1rem" }}>
              ...
              <Card emoji="🪵" title="Sentricon® for commercial buildings" body="In-ground termite bait stations around the perimeter of a commercial structure — no drilling required, no foundation disruption, and EnviroCare-backed damage coverage up to $1M on qualifying properties, subject to the terms of the agreement. Critical for buildings with valuable contents and continuous operations." />
