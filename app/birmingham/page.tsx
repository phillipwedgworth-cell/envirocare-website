    ...
    },
    {
      ...
      mainEntity: [
        ...
        },
        {
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text: "Mosquito season runs March through October in Birmingham. We apply the 30-day yard barrier monthly across those 8 months. $45 per treatment for mosquito only, or $65 per treatment for the Mosquito + Tick plan that adds tick coverage (worth it on any wooded Mountain Brook, Vestavia, or Chelsea property).",
          },
        },
        {
          "@type": "Question",
        ...
        <section style={{ padding: "5rem clamp(1.5rem,5vw,4rem)", background: Cr }}>
          <div style={{ maxWidth: 1100, margin: "0 auto" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(260px,1fr))", gap: "1.1rem" }}>
              ...
              <Card icon="mosquito" color="#0E7490" title="Mosquitoes along the Cahaba" body="Properties anywhere near the Cahaba River, Patton Creek, or Shades Creek see consistent mosquito pressure March–October. 30-day yard barrier at $45/treatment, or the Mosquito + Tick plan at $65/treatment which adds tick coverage and chiggers." />
