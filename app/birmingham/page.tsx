 ...
 * (Was Butler Rd / 940-6360 until the 16th Ave GBP verified — option B restored 2026-09-05.)
 */
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Birmingham's family-owned pest control and termite service. Four generations of Wedgworths, four Alabama offices, two ways to pay.",
  ...
  "@graph": [
    {
      ...
      areaServed: [
        ...
        { "@type": "City", name: "Irondale" },
        { "@type": "City", name: "Leeds" },
        { "@type": "City", name: "Moody" },
        { "@type": "City", name: "Fultondale" },
        { "@type": "City", name: "Gardendale" },
        { "@type": "City", name: "Bessemer" },
        { "@type": "City", name: "McCalla" },
      ],
    ...
    },
    {
      ...
      mainEntity: [
        ...
        },
        {
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text: "EnviroCare has been the Wedgworth family's Birmingham-area exterminator since 1958, now in our fourth generation. We're a Sentricon® Certified Specialist, locally owned (not a franchise or national chain), with our Birmingham office at 2120 16th Ave S and our main office in Alabaster. We're not the cheapest in town and we're not trying to be — we're the family that's been doing it longest.",
          },
        },
        {
          "@type": "Question",
        ...
        },
        {
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text: "All of them. Mountain Brook, Vestavia Hills, Homewood, Hoover, Alabaster, Pelham, Helena, Chelsea, Trussville, Greystone, Mt Laurel, Calera, and the city of Birmingham itself. Our Birmingham office is at 2120 16th Ave S, Birmingham, with the Alabaster office at 2025 Butler Road covering south Shelby County.",
          },
        },
        {
          "@type": "Question",
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text: "Mosquito season runs March through October in Birmingham. We apply the 30-day yard barrier monthly across those 8 months. $45 per month for mosquito only, or $65 per month for the Mosquito + Tick plan that adds tick coverage (worth it on any wooded Mountain Brook, Vestavia, or Chelsea property).",
          },
        },
        {
          "@type": "Question",
      ...
      <main style={{ background: "#fff", color: Ik, ...sans }}>
        ...
        <section style={{ padding: "5rem clamp(1.5rem,5vw,4rem)", background: "#fff" }}>
          <div style={{ maxWidth: 880, margin: "0 auto" }}>
            ...
            <Faq q="What's the best exterminator in Birmingham AL?" a="EnviroCare has been the Wedgworth family's Birmingham-area exterminator since 1958, now in our fourth generation. We're a Sentricon® Certified Specialist, locally owned (not a franchise or national chain), with our Birmingham office at 2120 16th Ave S and our main office in Alabaster. We're not the cheapest in town and we're not trying to be — we're the family that's been doing it longest." />
            ...
            <Faq q="When should I treat for mosquitoes in Birmingham?" a="Mosquito season runs March through October in Birmingham. We apply the 30-day yard barrier monthly across those 8 months. $45 per month for mosquito only, or $65 per month for the Mosquito + Tick plan that adds tick coverage (worth it on any wooded Mountain Brook, Vestavia, or Chelsea property)." />
