    ...
    },
    {
      ...
      mainEntity: [
        ...
        },
        {
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text: "Mosquito season runs March through November in Birmingham. We apply the 30-day yard barrier monthly across those 9 months. $45 per treatment for mosquito only, or $65 per treatment for the Outdoor Pro plan that adds tick coverage (worth it on any wooded Mountain Brook, Vestavia, or Chelsea property).",
          },
        },
        {
          "@type": "Question",
      ...
      <main style={{ background: "#fff", color: Ik, ...sans }}>
        ...
        <section style={{ padding: "5rem clamp(1.5rem,5vw,4rem)", background: Cr }}>
          <div style={{ maxWidth: 1100, margin: "0 auto" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(260px,1fr))", gap: "1.1rem" }}>
              ...
              <Card emoji="🦟" title="Mosquitoes along the Cahaba" body="Properties anywhere near the Cahaba River, Patton Creek, or Shades Creek see consistent mosquito pressure March–November. 30-day yard barrier at $45/treatment, or the Outdoor Pro plan at $65/treatment which adds tick coverage and chiggers." />
              ...
              <Card emoji="🐾" title="Ticks on Red Mountain &amp; Shades Mountain" body="Mountain Brook, Vestavia, and Chelsea homes backing up to the wooded ridges carry Lone Star and American dog ticks. The Outdoor Pro plan bundles mosquito + tick + chigger coverage — the actual biting trio you deal with from May through October." />
        ...
        <section style={{ padding: "5rem clamp(1.5rem,5vw,4rem)", background: "#fff" }}>
          ...
          <div style={{ maxWidth: 1100, margin: "0 auto", display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(240px,1fr))", gap: "1.25rem" }}>
            ...
            <Plan name="Outdoor Pro" price="$65" unit="/treatment" features={["Mosquito + tick + chigger","30-day yard barrier","Best for wooded Birmingham lots","March – November"]} />
          </div>
