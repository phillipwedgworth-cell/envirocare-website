...
const config: DeepCityConfig = {
  ...
  pressureCards: [
    { emoji: "🪵", title: "Termites in original & rebuilt homes", body: "Cahaba Heights's older ranches and freshly rebuilt lots both sit on moist soil that Eastern subterranean termites hunt. EnviroCare protects with Sentricon® — no drilling — up to $1,000,000 in coverage subject to the terms of the agreement." },
    { emoji: "🦟", title: "Mosquitoes off the Cahaba & Little Shades Creek", body: "The Cahaba River corridor and Little Shades Creek keep mosquito pressure high. The 30-day yard barrier treats March through October." },
  ...
  faqs: [
    ...
    { q: "Is there mosquito control in Cahaba Heights?", a: "Yes. EnviroCare treats Cahaba Heights yards every 30 days from March through October — eight treatments at $45 each, about $30 per month. Most homeowners see a clear seasonal reduction in mosquito activity." },
