...
export const metadata = {
  ...
  description: "Professional mosquito control for Alabama yards. Monthly treatments March–November. 50% off your first treatment. Family-owned since 1958. Free inspection.",
