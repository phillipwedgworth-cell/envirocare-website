...
const phaseACitiesBase: Record<string, CityData> = {
  ...
  "greystone": {
    ...
    heroLede: "Four generations of Wedgworths protecting Greystone Founders, Legacy, Cove and the rest of the 35242 corridor — from the golf course's fire ant pressure to the lake-lot mosquito holdouts. One technician. One invoice. All four programs.",
  ...
  "mt-laurel": {
    ...
    metaDescription: "Family-owned pest, termite, mosquito & tick control for Mt Laurel — Town Center, Founders Park, The Village, Double Oak. Sentricon® termite protection with $1M EnviroCare coverage.",
    office: "Birmingham",
    phone: "(205) 940-6360",
    tel: "2059406360",
    ...
    heroLede: "Family-owned pest, termite, mosquito and tick control for Mt Laurel residents — Town Center, Founders Park, The Village. Four generations of Wedgworths, one technician on your property, one invoice every month.",
    zipPrimary: "35242",
  ...
  "athens": {
    ...
    metaDescription: "Family-owned pest, termite, mosquito & tick control for Athens AL — Downtown, East Limestone, Tanner, Sanderfer. Sentricon® termite protection with $1M EnviroCare coverage. Call (256) 937-7676.",
    office: "Huntsville",
    phone: "(256) 937-7676",
    tel: "2569377676",
    ...
    heroLede: "Four generations of Wedgworths defending Athens, East Limestone, Tanner and Elkmont — from spring termite swarms in older downtown homes to the agricultural mosquito pressure in rural Limestone. Same family, family-owned since 1958.",
