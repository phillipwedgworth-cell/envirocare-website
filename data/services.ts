...
export const SERVICES: Service[] = [
  ...
  },
  {
    ...
    category: 'core',
    serviceArt: 'termite',
    price: '$325 to install',
    priceSub: 'then $380/yr to renew · or about $32/mo',
    metaTitle: 'Termite Control & Sentricon in Birmingham, AL | EnviroCare',
    metaDescription: 'Sentricon termite protection across Birmingham & Alabama. Colony elimination, $325 install or ~$32/mo. Family-owned since 1958. Call (205) 940-6360.',
    heroEyebrow: 'Sentricon® Certified Specialist',
    heroTagline: 'Termite Protection That Actually Works',
    heroSubhead: 'Sentricon® Always Active™ bait stations eliminate the termite colony at the source — including the queen. No drilling, no tank trucks, no concrete cutting. Protection includes a manufacturer-supported damage warranty on qualifying structures.',
    features: [
      'Sentricon® Always Active™ system',
      'Colony elimination — reaches the queen',
      'Manufacturer-supported damage warranty',
      'WDO termite letters for closings',
    ...
    includes: [
      ...
      { title: 'Always Active Monitoring', desc: 'Stations work year-round. Foraging termites carry the bait back to the colony and share it — including with the queen.' },
      { title: 'Damage Warranty', desc: 'Your protection includes a manufacturer-supported damage warranty on qualifying structures. Your technician will walk you through the current terms.' },
      { title: 'Real Estate WDO Letter', desc: 'Official Wood-Destroying Organism inspection letters (termite letters) for refinancing or selling, scheduled around your closing.' },
    ],
    wedgePoints: [
      ...
      { lead: 'Eliminates the colony at the source', body: 'Because termites feed each other, the bait moves through the whole colony. No queen, no colony — instead of just repelling termites from one spot.' },
    ...
    faqs: [
      { q: 'How do I know if I have termites?', a: 'Look for swarmers or discarded wings near windows in spring, mud tubes on your foundation, hollow-sounding wood, and paint that bubbles like it has water damage. If you spot any of these, the colony is already active — get an inspection.' },
      { q: 'How does Sentricon® get rid of termites?', a: 'Bait stations in the soil are taken back to the colony by foraging termites, who share it with the others, including the queen. That eliminates the whole colony at the source instead of just repelling termites from one spot.' },
      { q: 'How much does termite protection cost?', a: 'It\'s $325 to install with the first year\'s guarantee included, then $380/year to renew — or about $32/month.' },
      { q: 'Is Sentricon® better than a liquid barrier?', a: 'A liquid barrier tries to block termites at the soil line. Sentricon® eliminates the colony itself, including the queen, and the Always Active stations keep working year-round.' },
      { q: 'Do you provide termite letters for home sales?', a: 'Yes. We provide official WDO inspections for real estate closings and schedule them around your closing date.' },
    ],
    intro: [
      'Termites cause more damage to Alabama homes than fires and storms combined, and they do it quietly — often for years before anyone notices. By the time you see them, the colony has usually been feeding inside your home for a long time. EnviroCare protects homes across Birmingham, Huntsville, Lake Martin, and Auburn with the Sentricon® termite system, which doesn\'t just repel termites — it eliminates the colony at the source.',
      'The biggest threat here is the subterranean termite, which lives in the soil and tunnels up into your home through the foundation; in some areas we also see the aggressive Formosan termite. Watch for swarmers (winged termites) or discarded wings near windows in spring, mud tubes running up your foundation, hollow-sounding or soft wood around baseboards and door frames, and bubbling or uneven paint that looks like water damage. If you are seeing any of these, the colony is already active and time matters.',
      'Most old-style treatments create a chemical barrier in the soil. Sentricon® works differently: bait stations are placed in the soil around your home, and foraging termites take the bait back to the colony and share it — including with the queen. No queen, no colony. The Always Active stations work year-round, and the bait is more appealing to termites than the wood in your home.',
      'Simple termite pricing: $325 to install, which includes your first-year guarantee, then $380/year to renew protection after year one — or spread it out at about $32/month. Your protection includes a manufacturer-supported damage warranty on qualifying structures, and your technician will walk you through the current terms. If you need an official WDO inspection (termite letter) for a real estate closing, we handle those too, on a timeline that fits your closing date.',
    ],
  },
  {
