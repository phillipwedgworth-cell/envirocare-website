...
export const SERVICES: Service[] = [
  ...
  },
  {
    ...
    serviceArt: 'termite',
    price: '$32/mo',
    priceSub: 'or $325 install (incl. year-1) + $380/yr renewal',
  ...
  },
  {
    ...
    wedgePoints: [
      ...
      { lead: 'Bundles with tick', body: 'Same application handles ticks — and chiggers — in the Outdoor Pro plan ($49/mo). Fewer trips, same results.' },
    ...
    faqs: [
      ...
      { q: 'Can I add tick to my mosquito service?', a: 'Yes — our Mosquito + Tick (Outdoor Pro, $49/mo) adds tick and chigger coverage to the same mosquito visits. Same tech, same products, broader protection. Flea control is handled separately as an interior add-on, since fleas live indoors on pets and carpet, not just the yard.' },
  ...
  },
  {
    ...
    category: 'core',
    serviceArt: 'tick',
    price: 'Included with Mosquito + Tick',
    priceSub: '$49/mo Mosquito + Tick (chiggers covered)',
    ...
    faqs: [
      ...
      { q: 'Can I get tick control without mosquito?', a: 'No — tick control is part of our Mosquito + Tick (Outdoor Pro) program at $49/mo, not a standalone service. Ticks and mosquitoes share the same harborage — wood lines, leaf litter, shaded edges — so we treat them together on the same visits. Chiggers are covered too.' },
      ...
      { q: 'Do I need a separate exterminator for ticks?', a: 'No — tick control comes with our Mosquito + Tick service, handled by the same EnviroCare technician on the same visits. We focus on the wood lines, leaf litter, and shaded edges where ticks wait for a host, across Birmingham, Huntsville, and the Lake Martin area.' },
    ],
  },
