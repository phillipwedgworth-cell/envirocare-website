...
export const SERVICES: Service[] = [
  // ── CORE 4
  {
    ...
    intro: [
      ...
      'Straightforward pricing: about $35/month on auto-draft (ACH), or $70 per bi-monthly service. A quarterly option runs about $98, and the one-time initial service fee is $79. We serve Birmingham, Alabaster, Hoover, Mountain Brook, Vestavia Hills, Homewood, Trussville, and Chelsea; Huntsville, Madison, and Athens; and Alexander City, Lake Martin, and Auburn. A familiar local team handles your home whenever possible.',
    ],
    pestsFeatured: [
