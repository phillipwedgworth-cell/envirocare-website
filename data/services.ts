...
export const SERVICES: Service[] = [
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: 'Can I add tick and flea?', a: 'Yes. Our Outdoor Pro ($49/mo) covers Mosquito + Tick + Flea on the same visits. Same techs, same products, broader protection.' },
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: 'Can I get tick service without mosquito?', a: 'Yes — standalone tick treatment starts at $150, priced by the size of your yard. If you also want mosquito coverage, the Outdoor Bundle (Mosquito + Tick at $49/mo) is usually the simpler route.' },
