...
export const SERVICES: Service[] = [
  ...
  },
  {
    ...
    wedgePoints: [
      { lead: 'Built for Alabama', body: 'Our mosquito season runs April through October, not the generic "warm months." We schedule accordingly.' },
    ...
    faqs: [
      ...
      { q: 'When does the season start and end?', a: 'April through October in Alabama. We may extend earlier or later in warm springs/falls. Mosquitoes are inactive below 50°F.' },
  ...
  },
  {
    ...
    metaDescription: 'Yard flea barrier treatments. Bundles with mosquito & tick service. Pet-safe once dry. Call (205) 649-5278.',
