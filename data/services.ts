...
export const SERVICES: Service[] = [
  ...
  },
  {
    ...
    intro: [
      ...
      'Pricing is simple and predictable: the mosquito program runs about $45 per treatment across roughly eight treatments, which we spread evenly to about $30/month. If your yard backs up to woods, a field, or tall grass, ask about Mosquito + Tick — the same program plus tick and chigger coverage — at about $65 per treatment, spread to about $43.33/month. The tick add-on does not cover fleas; fleas are a separate interior-access service.',
    ...
    serviceArt: 'mosquito',
    price: 'About $30/mo',
    priceSub: '~$45/treatment · ~8 treatments Mar–Oct',
    metaTitle: 'Mosquito Control in Birmingham & Huntsville, AL | EnviroCare',
    metaDescription: 'Seasonal mosquito control (Mar–Oct) that significantly reduces yard mosquitoes. ~$30/mo. Add tick & chigger coverage. Call (205) 940-6360.',
    ...
    faqs: [
      ...
      { q: 'How much does mosquito control cost?', a: 'The mosquito program is about $45 per treatment, which we spread to roughly $30/month across the season. The mosquito + tick option (which also covers chiggers) is about $65 per treatment, or roughly $43.33/month.' },
  ...
  },
  {
    ...
    intro: [
      ...
      'Pricing: tick control is most commonly delivered as the mosquito + tick yard program — about $65 per treatment, roughly eight treatments March through October, spread to about $43.33/month. That option also covers chiggers, but does not cover fleas (a separate interior-access service). Want tick coverage on its own or a one-time treatment? Call and we\'ll quote it for your property.',
    ],
    name: 'Tick Control',
    shortName: 'Tick',
    category: 'core',
    serviceArt: 'tick',
    price: 'About $43.33/mo',
    priceSub: '~$65/treatment Mosquito + Tick · chiggers covered',
    metaTitle: 'Tick Control in Birmingham, AL | Yard Treatment | EnviroCare',
    metaDescription: 'Seasonal tick control that significantly reduces yard ticks & chiggers. ~$43.33/mo with mosquito. Birmingham & across Alabama. Call (205) 940-6360.',
    ...
    faqs: [
      ...
      { q: 'How much does tick control cost?', a: 'It\'s most commonly run as the mosquito + tick program — about $65 per treatment, or roughly $43.33/month spread across the season. That option also covers chiggers.' },
