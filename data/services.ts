...
export const SERVICES: Service[] = [
  ...
  },
  {
    ...
    serviceArt: 'mosquito',
    price: '$45/visit',
    priceSub: 'per service · March – November (9 visits)',
    ...
    faqs: [
      ...
      { q: 'Can I add tick to my mosquito service?', a: 'Yes — our Mosquito + Tick ($65/visit) adds tick and chigger coverage to the same mosquito visits. Same tech, same products, broader protection. Flea control is handled separately as an interior add-on, since fleas live indoors on pets and carpet, not just the yard.' },
  ...
  },
  {
    ...
    priceSub: '$65/visit Mosquito + Tick (chiggers covered)',
    ...
    faqs: [
      ...
      { q: 'Can I get tick control without mosquito?', a: 'No — tick control is part of our Mosquito + Tick program at $65/visit, not a standalone service. Ticks and mosquitoes share the same harborage — wood lines, leaf litter, shaded edges — so we treat them together on the same visits. Chiggers are covered too.' },
