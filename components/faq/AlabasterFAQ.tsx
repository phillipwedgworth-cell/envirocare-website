...
const ALABASTER_FAQS = [
  ...
  },
  {
    ...
    answer:
      'EnviroCare provides a monthly mosquito barrier service from March through October. Technicians target breeding sites and resting foliage around your yard to knock down adult mosquitoes and interrupt their life cycle. The yard barrier is $45/month and the Mosquito + Tick bundle (chiggers covered) is $65 per month, keeping outdoor spaces usable through the Alabama summer. Flea is an interior-plan add-on. Call (205) 940-6360.',
  },
  {
    question: 'Is EnviroCare a local business or a national franchise?',
    answer:
      'EnviroCare is a 100% locally owned Alabama business — not a national franchise. The family has been doing pest control in Alexander City, Alabama since 1958, and the business is now run by the fourth generation of the Wedgworth family — Phillip, Kevin, and Lex — the company independently operates offices in Alabaster, Alexander City, and Huntsville. When you hire EnviroCare, you work directly with Alabama business owners, not an out-of-state corporate chain.',
  },
];
        ...
        <div style={{
          ...
          <div>
            ...
            <p style={{ margin: '6px 0 0', fontSize: 14, opacity: 0.85 }}>
              Plans from $35/mo · Two ways to pay · Locally owned
            </p>
          </div>
