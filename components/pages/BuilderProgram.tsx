...
export default function BuilderProgram() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* HERO */}
      <section className="relative overflow-hidden text-white py-20 md:py-28" style={{background:"linear-gradient(135deg, #0f2d1a 0%, #1B7A3C 60%, #0f4d26 100%)"}}>
      ...
      <section className="py-20 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              <p className="font-semibold text-sm uppercase tracking-wider mb-3" style={{color:"#1B7A3C"}}>More Than a Vendor</p>
              ...
              <div className="space-y-3">
                {[
                  ...
                  <div key={i} className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 flex-shrink-0 mt-0.5" style={{color:"#1B7A3C"}} />
            ...
            <div className="space-y-4">
              ...
              <div className="p-6 rounded-2xl border-2 text-white" style={{background:"#1B7A3C", borderColor:"#F5A800"}}>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <div key={i} className={`p-6 rounded-xl border-2 transition ${service.highlight ? "text-white" : "bg-white border-slate-200 hover:border-green-300 hover:shadow-md"}`}
                style={service.highlight ? {background:"#1B7A3C", borderColor:"#F5A800"} : {}}>
                <div className="mb-4" style={{color: service.highlight ? "#F5A800" : "#1B7A3C"}}>{service.icon}</div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              const colors = {
                ...
                green: { border: "#1B7A3C", badge: "#f0fdf4", badgeText: "#166534" },
