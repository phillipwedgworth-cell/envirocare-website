        ...
        <div style={{ maxWidth: 1000, margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", gap: 18 }}>
            {[
              ...
              { icon: "🐜", name: "Pest Control", primary: false, desc: "Full perimeter pest control for Eclectic homes. Bi-monthly programs keep ants, spiders, roaches, and other pests out all season. Suited for waterfront properties.", offer: "$50 off first service" },
              ...
              { icon: "📦", name: "Bundle Your Services", primary: false, desc: "Most Eclectic homeowners combine Pest + Mosquito + Termite. One simple monthly plan, maximum protection. Premium package available for waterfront properties.", offer: "Best value" },
            ].map((s, i) => (
