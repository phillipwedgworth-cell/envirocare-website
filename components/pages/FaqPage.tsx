    ...
    <>
      ...
      <section className="faq-cat">
        <div className="container">
          <div className="section-eyebrow">About EnviroCare</div>
          <h2 className="section-title" style={{textAlign:'center'}}>General</h2>
          <div className="faq-list-wide">
            <details className="faq-item">
              <summary className="faq-q">Are you really family-owned since 1958?</summary>
              <div className="faq-a">Yes. The Wedgworth family started EnviroCare in 1958 in Alexander City, Alabama. We're now in our fourth generation. Kevin Wedgworth is the current owner; his father and grandfather built the business before him, and the fourth generation of the family works in the business today.</div>
            </details>
            <details className="faq-item">
              <summary className="faq-q">How many offices do you have?</summary>
              <div className="faq-a">Three — Birmingham (Alabaster), Alexander City (which also covers Lake Martin and the Auburn area), and Huntsville. We service 26 cities across Alabama from these locations.</div>
            </details>
            <details className="faq-item">
            ...
            <details className="faq-item">
              ...
              <div className="faq-a">Most non-emergency calls are scheduled within 5 business days. Emergency situations (active infestation, fire ant stings, etc.) get same- or next-day response.</div>
            </details>
          </div>
        </div>
      </section>
      <section className="faq-cat">
        <div className="container">
          ...
          <h2 className="section-title" style={{textAlign:'center'}}>Pricing & Plans</h2>
          <div className="faq-list-wide">
            <details className="faq-item">
            ...
            <details className="faq-item">
              ...
              <div className="faq-a">Termite is priced after a free WDO inspection — Alabama requires it, and your Sentricon® price depends on your home's linear footage and foundation type. Coverage includes up to $1,000,000 in termite damage repair coverage, annual inspection, and one WDO letter per year. The inspection is always free.</div>
            </details>
            <details className="faq-item">
            ...
            <details className="faq-item">
              ...
              <div className="faq-a">Startup fees are $75 for pest, $75 for pest + mosquito, and $229 for the Complete bundle. Termite is priced at your free WDO inspection. Mosquito or tick booked on their own have no startup — they're billed per visit.</div>
            </details>
            <details className="faq-item">
              <summary className="faq-q">Do you offer one-time treatments?</summary>
              <div className="faq-a">Yes for specific problems (fire ants, fleas, etc.). Most homeowners do better with ongoing service since pests come back without prevention.</div>
            </details>
          </div>
        </div>
      </section>
      <section className="faq-cat">
        <div className="container">
          <div className="section-eyebrow">Termite Specifically</div>
          <h2 className="section-title" style={{textAlign:'center'}}>Termite & Sentricon</h2>
          <div className="faq-list-wide">
            <details className="faq-item">
              <summary className="faq-q">How is Sentricon® different from liquid termite treatments?</summary>
              <div className="faq-a">Liquid treatments create a chemical barrier in the soil — they require drilling through concrete, work for 5-7 years before retreatment, and don't eliminate the colony. Sentricon® places bait stations in the ground that termites carry back to the colony, eliminating the whole population. No drilling required.</div>
            </details>
            <details className="faq-item">
            ...
            <details className="faq-item">
              ...
              <div className="faq-a">No. Bait stations are about the size of a soda can and installed flush with the ground around your home perimeter. No drilling, no concrete cuts, no torn-up flowerbeds.</div>
            </details>
            <details className="faq-item">
              <summary className="faq-q">How fast does Sentricon® work?</summary>
              <div className="faq-a">Active termite colonies typically die out within 90 days of bait stations being installed. Sentricon® works by sterilizing the queen — without her, the colony collapses.</div>
            </details>
            <details className="faq-item">
              <summary className="faq-q">Can you do a WDO inspection for refinancing or selling?</summary>
              <div className="faq-a">Yes — we provide the Official Alabama Wood Infestation Inspection Report (the Wood-Destroying Organism letter) accepted by every Alabama lender. One free per year on active accounts; $125 standalone fee otherwise.</div>
            </details>
          </div>
        </div>
      </section>
      <section className="faq-cat">
        <div className="container">
          <div className="section-eyebrow">Outdoor Living</div>
          <h2 className="section-title" style={{textAlign:'center'}}>Mosquito & Tick</h2>
          <div className="faq-list-wide">
            <details className="faq-item">
              <summary className="faq-q">When does mosquito season run in Alabama?</summary>
              <div className="faq-a">March through October. Mosquitoes are inactive below 50°F. We may extend earlier or later in warm springs/falls.</div>
            </details>
            <details className="faq-item">
            ...
            <details className="faq-item">
              ...
              <div className="faq-a">We avoid direct application to flowering plants and bee/butterfly habitat. Bee-safe practices are standard — we won't spray actively flowering plants.</div>
            </details>
          </div>
        </div>
      </section>
      <section className="faq-cat">
        <div className="container">
          <div className="section-eyebrow">What We Use</div>
          <h2 className="section-title" style={{textAlign:'center'}}>Safety & Products</h2>
          <div className="faq-list-wide">
            <details className="faq-item">
              <summary className="faq-q">What products do you use?</summary>
              <div className="faq-a">EPA-registered products applied to manufacturer specifications. Specific products vary by service (pest, termite, mosquito, tick) and target pest. We can provide the exact label for any application if you ask.</div>
            </details>
            <details className="faq-item">
              <summary className="faq-q">How long until my pets/kids can go back in the yard?</summary>
              <div className="faq-a">Typically 30 minutes — once the application is dry. We apply during weather conditions that allow quick drying.</div>
            </details>
            <details className="faq-item">
              <summary className="faq-q">Do you treat inside the house?</summary>
              <div className="faq-a">Interior service is included free on request between bi-monthly visits. We focus on exterior perimeter treatment since 90%+ of pests enter from outside, but interior is available anytime.</div>
            </details>
            <details className="faq-item">
              <summary className="faq-q">What if I'm pregnant or have a newborn?</summary>
              <div className="faq-a">Mention it when scheduling and we'll discuss timing, products, and safety protocols. We've handled this many times — we'll work with your concerns.</div>
            </details>
          </div>
        </div>
      </section>
