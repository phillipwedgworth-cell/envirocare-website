...
// Path: components/pages/ServicesIndexPage.tsx
    ...
    <>
      ...
      <section className="page-hero">
        <div className="page-hero-inner">
          ...
          <p className="page-hero-sub">Bi-monthly pest control, seasonal mosquito service with quoted tick options, and Sentricon® termite protection with up to $1M coverage, subject to the terms of the agreement — plus specialty options for fire ants, fleas, builders, real estate, and commercial properties.</p>
        ...
        <div className="container">
          ...
          <div className="services-grid">
            ...
            <a href="/services/mosquito" className="svc-card">
              ...
              <div className="svc-card-price">$45/month · tick options quoted</div>
              <div className="svc-card-desc">30-day yard barrier March through October. Ask about quoted tick protection for wooded lots and lake homes. EPA-registered products, applied per label directions.</div>
              <span className="svc-card-link">Learn more →</span>
            </a>
      ...
      <section className="services-grid-section" style={{background:'var(--white)'}}>
        <div className="container">
          <div className="section-eyebrow">Specialty Services</div>
          <h2 className="section-title">For <span>Specific Needs</span></h2>
...
.svc-card-name{font-family:var(--font-serif);font-size:1.35rem;font-weight:800;color:var(--green-deep);margin-bottom:.4rem;line-height:1.15}
.svc-card-price{font-family:var(--font-serif);font-size:1.15rem;color:var(--gold-deep);font-weight:700;margin-bottom:.7rem}
...
.not-found-num{font-family:var(--font-serif);font-size:clamp(7rem,18vw,12rem);font-weight:900;color:var(--gold);line-height:1;margin-bottom:.5rem;letter-spacing:-4px}
.not-found-h{font-family:var(--font-serif);font-size:clamp(1.8rem,4vw,2.8rem);font-weight:900;color:#fff;margin-bottom:1.2rem;line-height:1.1}
...
.nf-link-title{font-family:var(--font-serif);font-size:1.1rem;font-weight:700;color:#fff}
`;
