      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-emerald-900 via-emerald-800 to-slate-900 text-white py-20 md:py-32">
        ...
        <div className="relative max-w-6xl mx-auto px-6 text-center">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
            Madison County, Huntsville's Pest Control Leaders
          </h1>

          <p className="text-lg md:text-xl text-emerald-50 max-w-3xl mx-auto mb-8 leading-relaxed">
            Huntsville's trusted pest control company. Fast response times, proven results, family-owned expertise since 1958.
          </p>
      ...
      <section className="py-16 md:py-24 px-6 max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">
            Why Huntsville Chooses EnviroCare
          </h2>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {[
              ...
              {
                name: "Tick Control",
                description: "Tick control for Huntsville foothill yards and Monte Sano trail properties. Applied per label directions."
              },
              {
                name: "Commercial Pest Control",
                description: "For Huntsville businesses, restaurants, and Research Park facilities. Discreet, compliant service."
              }
            ].map((service, idx) => (
