...
import { TreePine, Droplets, House, CalendarDays, Hammer, ScrollText, PenLine } from "lucide-react";
      ...
      <section className="blog-section">
        <div className="container">
          ...
          <div className="blog-grid">
            <div className="blog-card"><div className="blog-thumb"><div className="blog-thumb-icon"><TreePine size={52} strokeWidth={1.7} aria-hidden="true" /></div></div><div className="blog-body"><div className="blog-cat">Termite</div><div className="blog-title">Sentricon® vs Liquid Treatments: The Real Difference</div><div className="blog-excerpt">Why bait stations beat liquid barriers for Alabama homes — and what the chemical industry doesn\'t want you to know about retreat cycles.</div><div className="blog-meta"><span>Coming Soon</span><span>~8 min read</span></div></div></div>
            <div className="blog-card"><div className="blog-thumb"><div className="blog-thumb-icon"><Droplets size={52} strokeWidth={1.7} aria-hidden="true" /></div></div><div className="blog-body"><div className="blog-cat">Mosquito</div><div className="blog-title">When To Start Mosquito Service In Alabama</div><div className="blog-excerpt">The March-November window most homeowners get wrong. Why starting in March beats waiting for the first bite — and what that means for your yard.</div><div className="blog-meta"><span>Coming Soon</span><span>~5 min read</span></div></div></div>
            <div className="blog-card"><div className="blog-thumb"><div className="blog-thumb-icon"><House size={52} strokeWidth={1.7} aria-hidden="true" /></div></div><div className="blog-body"><div className="blog-cat">Home</div><div className="blog-title">5 Signs You Have Termites You\'re Missing</div><div className="blog-excerpt">It\'s not just hollow wood. The subtle Alabama-specific signs of subterranean termite activity that even experienced homeowners overlook.</div><div className="blog-meta"><span>Coming Soon</span><span>~6 min read</span></div></div></div>
            <div className="blog-card"><div className="blog-thumb"><div className="blog-thumb-icon"><CalendarDays size={52} strokeWidth={1.7} aria-hidden="true" /></div></div><div className="blog-body"><div className="blog-cat">Seasonal</div><div className="blog-title">Alabama Pest Calendar: What To Expect Each Month</div><div className="blog-excerpt">From spring ant invasions to fall mouse migration, what every Alabama homeowner should expect — and prepare for — month by month.</div><div className="blog-meta"><span>Coming Soon</span><span>~10 min read</span></div></div></div>
            <div className="blog-card"><div className="blog-thumb"><div className="blog-thumb-icon"><Hammer size={52} strokeWidth={1.7} aria-hidden="true" /></div></div><div className="blog-body"><div className="blog-cat">Builders</div><div className="blog-title">Pre-Slab Termite Treatment: A Builder\'s Guide</div><div className="blog-excerpt">Alabama code requirements, the right timing, and why coordinating with your pest pro before pour day saves money on the back end.</div><div className="blog-meta"><span>Coming Soon</span><span>~7 min read</span></div></div></div>
            <div className="blog-card"><div className="blog-thumb"><div className="blog-thumb-icon"><ScrollText size={52} strokeWidth={1.7} aria-hidden="true" /></div></div><div className="blog-body"><div className="blog-cat">Heritage</div><div className="blog-title">68 Years: A History Of EnviroCare</div><div className="blog-excerpt">From a 1958 single-truck operation in Alexander City to three offices across Alabama — the Wedgworth family story, told by the fourth generation.</div><div className="blog-meta"><span>Coming Soon</span><span>~12 min read</span></div></div></div>
          </div>

          <div className="blog-empty">
            <div className="blog-empty-icon"><PenLine size={48} strokeWidth={1.7} aria-hidden="true" /></div>
