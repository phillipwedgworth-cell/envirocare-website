      ...
      <section className="blog-section">
        <div className="container">
          ...
          <div className="blog-grid">
            ...
            <div className="blog-card"><div className="blog-thumb"><div className="blog-thumb-icon">📜</div></div><div className="blog-body"><div className="blog-cat">Heritage</div><div className="blog-title">68 Years: A History Of EnviroCare</div><div className="blog-excerpt">From a 1958 single-truck operation in Alexander City to three offices across Alabama — the Wedgworth family story, told by the fourth generation.</div><div className="blog-meta"><span>Coming Soon</span><span>~12 min read</span></div></div></div>
          </div>
