...
// Path: components/pages/BlogPage.tsx
// Commit: fix(fonts): font tokens, drop Google Fonts loader
// Push: main
// ───────────────────────────────────
    ...
    <>
      ...
      <section className="blog-section">
        <div className="container">
          ...
          <h2 className="section-title">Articles In <span>The Works</span></h2>

          <div className="blog-grid">
            <div className="blog-card"><div className="blog-thumb"><div className="blog-thumb-icon"><PestIcon name="termite" size={32} style={{ color: "#C77A00" }} /></div></div><div className="blog-body"><div className="blog-cat">Termite</div><div className="blog-title">Sentricon® vs Liquid Treatments: The Real Difference</div><div className="blog-excerpt">Why bait stations beat liquid barriers for Alabama homes — and what the chemical industry doesn\'t want you to know about retreat cycles.</div><div className="blog-meta"><span>Coming Soon</span><span>~8 min read</span></div></div></div>
            <div className="blog-card"><div className="blog-thumb"><div className="blog-thumb-icon"><PestIcon name="mosquito" size={32} style={{ color: "#0E7490" }} /></div></div><div className="blog-body"><div className="blog-cat">Mosquito</div><div className="blog-title">When To Start Mosquito Service In Alabama</div><div className="blog-excerpt">The March-October window most homeowners get wrong. Why starting in March beats waiting for the first bite — and what that means for your yard.</div><div className="blog-meta"><span>Coming Soon</span><span>~5 min read</span></div></div></div>
            <div className="blog-card"><div className="blog-thumb"><div className="blog-thumb-icon"><PestIcon name="home" size={32} style={{ color: "#0A7935" }} /></div></div><div className="blog-body"><div className="blog-cat">Home</div><div className="blog-title">5 Signs You Have Termites You\'re Missing</div><div className="blog-excerpt">It\'s not just hollow wood. The subtle Alabama-specific signs of subterranean termite activity that even experienced homeowners overlook.</div><div className="blog-meta"><span>Coming Soon</span><span>~6 min read</span></div></div></div>
            <div className="blog-card"><div className="blog-thumb"><div className="blog-thumb-icon"><PestIcon name="leaf" size={32} style={{ color: "#0E8E40" }} /></div></div><div className="blog-body"><div className="blog-cat">Seasonal</div><div className="blog-title">Alabama Pest Calendar: What To Expect Each Month</div><div className="blog-excerpt">From spring ant invasions to fall mouse migration, what every Alabama homeowner should expect — and prepare for — month by month.</div><div className="blog-meta"><span>Coming Soon</span><span>~10 min read</span></div></div></div>
            <div className="blog-card"><div className="blog-thumb"><div className="blog-thumb-icon"><PestIcon name="building" size={32} style={{ color: "#0A7935" }} /></div></div><div className="blog-body"><div className="blog-cat">Builders</div><div className="blog-title">Pre-Slab Termite Treatment: A Builder\'s Guide</div><div className="blog-excerpt">Alabama code requirements, the right timing, and why coordinating with your pest pro before pour day saves money on the back end.</div><div className="blog-meta"><span>Coming Soon</span><span>~7 min read</span></div></div></div>
            <div className="blog-card"><div className="blog-thumb"><div className="blog-thumb-icon"><ScrollText size={32} color="#9A5B2E" /></div></div><div className="blog-body"><div className="blog-cat">Heritage</div><div className="blog-title">68 Years: A History Of EnviroCare</div><div className="blog-excerpt">From a 1958 single-truck operation in Alexander City to four offices across Alabama — the Wedgworth family story, told by the fourth generation.</div><div className="blog-meta"><span>Coming Soon</span><span>~12 min read</span></div></div></div>
          </div>

          <div className="blog-empty">
            <div className="blog-empty-icon"><PenLine size={36} color="#0E8E40" /></div>
            <div className="blog-empty-h">Blog Launching Soon</div>
            <div className="blog-empty-p">Real Alabama pest knowledge from 68 years in the field. Want a specific topic covered? Call us — your question might become the next post.</div>
          </div>
        </div>
      </section>
...
.page-hero h1{font-family:var(--font-serif);font-size:clamp(2.6rem,5vw,4.4rem);font-weight:900;line-height:1.02;color:#fff;margin-bottom:1.2rem;letter-spacing:-.5px}
...
.rev-quote{font-family:var(--font-serif);font-size:1.08rem;font-style:italic;color:var(--ink);line-height:1.5;margin-bottom:1.2rem;flex:1}
...
.google-cta-num{font-family:var(--font-serif);font-size:clamp(2rem,4vw,3rem);font-weight:900;color:var(--green-deep);line-height:1;margin-bottom:.4rem}
...
.blog-title{font-family:var(--font-serif);font-size:1.25rem;font-weight:700;color:var(--ink);line-height:1.25;margin-bottom:.7rem;flex:1}
...
.blog-empty-h{font-family:var(--font-serif);font-size:1.4rem;color:var(--green-deep);margin-bottom:.6rem;font-weight:700}
