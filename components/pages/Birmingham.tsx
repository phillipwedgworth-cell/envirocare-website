      ...
      <script type="application/ld+json">{`
        {
          ...
          "@type": "LocalBusiness",
          "name": "EnviroCare Pest Control - Birmingham, AL",
          "image": "https://envirocarellc.com/logo.png",
          "description": "Professional pest control, termite treatment, and mosquito control in Birmingham, AL",
          "address": {
            "@type": "PostalAddress",
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-emerald-900 via-emerald-800 to-slate-900 text-white py-20 md:py-32">
        ...
        <div className="relative max-w-6xl mx-auto px-6 text-center">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
            Birmingham's Pest Control Leaders
          </h1>

          <p className="text-lg md:text-xl text-emerald-50 max-w-3xl mx-auto mb-8 leading-relaxed">
            Serving greater Birmingham since 1958. Licensed technicians, eco-friendly treatments, same-day availability.
          </p>
      ...
      <section className="py-16 md:py-24 px-6 max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">
            Why Birmingham Chooses EnviroCare
          </h2>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {[
              ...
              {
                name: "Tick Control",
                description: "Tick suppression for Birmingham yards, wooded edges, and family pet areas. Year-round protection."
              },
              {
                name: "Commercial Pest Control",
                description: "For Birmingham businesses, restaurants, and facilities. Discreet, compliant service."
              }
            ].map((service, idx) => (
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <p className="text-sm">📞 (205) 940-6360</p>
            </div>
            <div>
