        ...
        <div className="container">
          ...
          <div className="prog-grid">
            ...
            <div className="prog-card"><div className="prog-art prog-art-3"><div className="prog-art-grid"></div></div>
              <div className="prog-body"><div className="prog-name">Mosquito Control</div><div className="prog-desc">21-day yard barrier April–October. Make your outdoor space livable again.</div>
                <ul className="prog-features"><li><span className="prog-chk">✓</span>April–October coverage</li><li><span className="prog-chk">✓</span>21-day refresh</li><li><span className="prog-chk">✓</span>Pet- & kid-safe once dry</li></ul>
