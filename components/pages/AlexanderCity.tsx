...
export default function MadisonLandingPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-emerald-900 via-emerald-800 to-slate-900 text-white py-20 md:py-32">
        ...
        <div className="relative max-w-6xl mx-auto px-6 text-center">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
            Lake Martin's Pest Control Experts
          </h1>

          <p className="text-lg md:text-xl text-emerald-50 max-w-3xl mx-auto mb-8 leading-relaxed">
            Professional pest control for Alexander City and Lake Martin. Protecting waterfront properties since 1958.
          </p>
      ...
      <section className="py-16 md:py-24 px-6 max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">
            Why Alexander City Chooses EnviroCare
          </h2>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {[
              ...
              {
                name: "Tick Control",
                description: "Tick treatments for Alexander City and Lake Martin wooded yards and waterfront properties."
              },
              {
                name: "Commercial Pest Control",
                description: "For Alexander City and Lake Martin businesses, restaurants, and marinas. Discreet, compliant service."
              }
            ].map((service, idx) => (
      ...
      <section className="py-16 md:py-24 px-6 max-w-6xl mx-auto">
        <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4 text-center">
          Flexible Plans for Alexander City
        </h2>
        <p className="text-center text-slate-600 mb-16 text-lg">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <p className="text-sm">📞 (256) 234-6162</p>
            </div>
            <div>
