...
// Path: components/pages/RealtorPage.tsx
    ...
    <>
      ...
      <section className="flow-section">
        <div className="container">
          ...
          <h2 className="section-title">From Order To <span>Closing Table</span></h2>
          <p className="section-sub">Four steps. No surprises. No closing delays.</p>
          <div className="flow-grid">
            <div className="flow-card">
              <div className="flow-num">1</div>
              <div className="flow-title">You Order</div>
              <div className="flow-desc">Call or email service@envirocarellc.com with property address, target closing date, and access details.</div>
            </div>
            <div className="flow-card">
              <div className="flow-num">2</div>
              <div className="flow-title">We Inspect</div>
              <div className="flow-desc">Trained tech checks all accessible areas — attic, crawlspace, garage, exterior. 45-60 min on average.</div>
            </div>
            <div className="flow-card">
            ...
            <div className="flow-card">
              ...
              <div className="flow-title">Treatment If Needed</div>
              <div className="flow-desc">If we find active issues, you get photos + quote so you can negotiate. We can treat before closing.</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="wedge" style={{background:'var(--white)'}}>
        <div className="container">
          <div className="section-eyebrow">For Closing Attorneys & Title</div>
          <h2 className="section-title">Built For <span>Closing Speed</span></h2>
          <div className="wedge-grid">
            ...
            <div className="wedge-card">
              <div className="wedge-lead">Fast Turnaround</div>
              <div className="wedge-body">Closing tomorrow and the lender needs WDO? Call us — we\'ll prioritize your inspection when possible.</div>
            </div>
          </div>
        </div>
      </section>
...
.flow-num{position:absolute;top:-14px;left:1.6rem;background:var(--gold);color:var(--ink);width:36px;height:36px;border-radius:50%;display:flex;align-items:center;justify-content:center;font-family:var(--font-serif);font-weight:900;font-size:1.05rem;border:3px solid var(--cream)}
.flow-title{font-family:var(--font-serif);font-size:1.2rem;font-weight:700;color:var(--green-dk);margin:.8rem 0 .6rem;line-height:1.25}
...
.stat-band-n{font-family:var(--font-serif);font-size:clamp(2rem,4vw,3rem);font-weight:900;color:var(--gold);line-height:1;margin-bottom:.4rem}
