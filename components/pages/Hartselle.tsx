      ...
      <script type="application/ld+json">{`
        {
          ...
          "@type": "LocalBusiness",
          "name": "EnviroCare Pest Control - Hartselle, AL",
          "image": "https://www.envirocarellc.com/logo.png",
          "description": "Professional pest control, termite treatment, and mosquito control in Hartselle, AL",
          "address": {
            "@type": "PostalAddress",
          ...
          "url": "https://www.envirocarellc.com/hartselle",
          "sameAs": [
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-emerald-900 via-emerald-800 to-slate-900 text-white py-20 md:py-32">
        ...
        <div className="relative max-w-6xl mx-auto px-6 text-center">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
            Hartselle Pest Control
          </h1>

          <p className="text-lg md:text-xl text-emerald-50 max-w-3xl mx-auto mb-8 leading-relaxed">
            Serving Hartselle with professional pest control. Local expertise, call for availability.
          </p>
      ...
      <section className="py-16 md:py-24 px-6 max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">
            Why Hartselle Chooses EnviroCare
          </h2>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {[
              ...
              {
                name: "Tick Control",
                description: "Tick control for Hartselle yards bordered by woods, creeks, and farmland."
              },
              {
                name: "Commercial Pest Control",
                description: "For Hartselle and Morgan County businesses and shops. Discreet, compliant service."
              }
            ].map((service, idx) => (
