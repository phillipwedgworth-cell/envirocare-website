        ...
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          ...
          <div style={{
            ...
            <ServiceCard ribbon="Mar – Nov" icon="🦟" title="Mosquito Control" price="$45" priceUnit="/mo · seasonal"
              ...
              bullets={["Up to 9 seasonal applications", "Pet & kid-safe once dry", "Targets harborage zones", "50% off first application"]} />
            <ServiceCard icon="🐾" title="Tick Control" price="$60" priceUnit="/mo · with mosquito"
              ...
              bullets={["Lone Star, Dog & Deer ticks", "Harborage-zone targeting", "Bundles free with mosquito", "Pet & family safe"]} />
          </div>
        </div>
      </section>
